...
- **Ближайшие задачи:** только скриншоты ЛК для placement_* (FBO →
  Стоимость размещения) и returns — сверить последние два cabinet-пути
  (дока для них ненадёжна, см. урок #60).
