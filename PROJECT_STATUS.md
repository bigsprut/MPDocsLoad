...
- **Ближайшие задачи:** крупных не осталось. Опционально: живой GUI-прогон
  фоллбэка postings (ветка Журнала), test-clean-env на последнем бандле,
  сверка ЛК-путей placement_* (FBO → Стоимость размещения) и returns —
  остались по доке, скриншотами не покрыты.
