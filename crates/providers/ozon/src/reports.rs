...
static REPORT_DEFS: &[ReportDef] = &[
    ...
    ReportDef {
        ...
        url: Some("https://seller.ozon.ru/app/finances/documents?type=realizationReports&tab=closingDocuments"),
    ...
    ReportDef {
        ...
        url: Some("https://seller.ozon.ru/app/finances/documents?type=realizationReports&tab=informationalDocuments"),
