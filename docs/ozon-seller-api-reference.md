# Ozon Seller API — справочник (копия документации)

> Источник: `https://docs.ozon.ru/api/seller/` (Seller API 2.1).
> Скопировано пользователем 2026-08-05 (сайт под антибот-челленджем — прямого
> автоматического доступа нет). Хранится локально для сверки эндпоинтов/тел
> запросов при разработке MDWF. Контент принадлежит Ozon.
>
> В начале файла — артефакты копирования UI (меню/кнопки); сами методы — ниже,
> ищите по путям эндпоинтов (напр. `/v2/finance/realization`).
...
Начало работы
С 16.05.2025 в Seller API можно обращаться только back-to-back, прямые запросы из браузера будут запрещены. Такие запросы будут падать с ошибкой политики CORS.

Если оферта неактуальна, доступ к Seller API будет ограничен. Вы получите ошибку 403 Offer not signed. Чтобы возобновить доступ, примите оферту.
Подробнее о принятии оферты
...
Зарегистрируйтесь в Ozon Seller. Подробнее о регистрации в Базе знаний продавца.
Примите оферту.
Получите API-ключ.
Как получить API-ключ
Не передавайте API-ключ посторонним людям
Запросы к API изменяют данные в вашем магазине на Ozon. Если доступ к ключу будет у посторонних, они смогут управлять вашим магазином.

Чтобы получить API-ключ:

В личном кабинете перейдите в Настройки → Seller API.
Нажмите Сгенерировать ключ.
Придумайте название для ключа и выберите его уровень доступа.
...
Получите дату истечения срока действия ключа в параметре expires_at метода /v1/roles.
...
В личном кабинете перейдите в Настройки → Seller API.
Удалите текущий API-ключ и создайте новый.
Авторизация через OAuth-токен
...
Если нужно обновить только характеристики товара, используйте /v1/product/attributes/update. Метод позволяет добавить дополнительную информацию к товару, чтобы карточка товара была более полной.
...
/v4/product/info/attributes — получите описание характеристик товара.

/v1/product/info/description — получите название и описание товара.
...
Для получения информации о количестве остатков для FBO, FBS, rFBS и FBP используйте /v4/product/info/stocks.

Для получения информации о количестве остатков для FBS и rFBS используйте /v2/product/info/stocks-by-warehouse/fbs.
...
Чтобы проверить резервирование товара, используйте методы /v2/product/info/stocks-by-warehouse/fbs или /v4/product/info/stocks.
...
одобрить — используйте метод /v1/actions/discounts-task/approve,
отклонить — используйте метод /v1/actions/discounts-task/decline.
Подробнее об акциях Ozon в Базе знаний продавца

Работа с акциями продавца
Создайте акцию:
/v1/seller-actions/create/discount — с механикой «Скидка»;
/v1/seller-actions/create/discount-with-condition — с механикой «Скидка от суммы заказа»;
/v1/seller-actions/create/installment — с механикой «Беспроцентная рассрочка»;
/v1/seller-actions/create/multi-level-discount — с механикой «Многоуровневая скидка от суммы»;
/v1/seller-actions/create/voucher — с механикой «Скидка по промокоду».
Отредактируйте акцию:
/v1/seller-actions/update/discount — с механикой «Скидка»;
/v1/seller-actions/update/discount-with-condition — с механикой «Скидка от суммы заказа»;
/v1/seller-actions/update/installment — с механикой «Беспроцентная рассрочка»;
/v1/seller-actions/update/multi-level-discount — с механикой «Многоуровневая скидка от суммы»;
/v1/seller-actions/update/voucher — с механикой «Скидка по промокоду».
/v1/seller-actions/list — получите список созданных акций.
/v1/seller-actions/products/candidates — получите список товаров, которые могут участвовать в акции.
/v1/seller-actions/products/add — добавьте товары в акцию.
/v1/seller-actions/products/list — получите список товаров, которые участвуют в акции.
/v1/seller-actions/products/delete — удалите товары из акции.
/v1/seller-actions/voucher/get — получите список промокодов для акции с механикой «Скидка по промокоду».
/v1/seller-actions/change-activity — включите или выключите акцию.
/v1/seller-actions/archive — поместите акцию в архив.
...
На которые установлена минимальная цена с помощью метода /v1/product/import/prices. Чтобы проверить цену, используйте метод /v5/product/info/prices.
Которые не привязаны к другой стратегии. Чтобы проверить привязку товара к стратегии, используйте метод /v1/pricing-strategy/strategy-ids-by-product-ids.
...
/v2/delivery-method/list — получите список методов rFBS-склада.

/v2/warehouse/list — получите список складов.

Работа с FBS-складами
Создайте новый склад
/v1/warehouse/fbs/create/drop-off/list — получите список drop-off точек и выберите одну, чтобы создать склад.
/v1/warehouse/fbs/return-mile/check — проверьте необходимость установки возвратной мили.
/v1/warehouse/fbs/create/return-point/list — получите список возвратных пунктов для создания склада.
/v1/warehouse/fbs/create — отправьте запрос на создание нового склада.
/v1/warehouse/operation/status — получите статус операции на создание нового склада.
/v2/warehouse/list — получите подробную информацию о складе по warehouse_id.
Обновите настройки склада
/v1/warehouse/fbs/update — отправьте запрос на обновление настроек склада.
/v1/warehouse/operation/status — получите статус обновления информации о складе.
Обновите первую милю склада
/v1/warehouse/fbs/return-mile/info — проверьте необходимость передачи возвратной мили.
/v1/warehouse/fbs/update/return-point/list — получите список пунктов возвратов для обновления склада.
/v1/warehouse/fbs/update/drop-off/list — получите список drop-off точек и выберите одну, чтобы обновить информацию о складе.
/v1/warehouse/fbs/first-mile/update — отправьте запрос на обновление первой мили.
/v1/warehouse/operation/status — получите статус обновления первой мили.
Архивируйте склад
/v1/warehouse/fbs/return-mile/info или /v1/warehouse/fbs/return-mile/check — проверьте необходимость установки возвратной мили.
/v1/warehouse/fbs/update/return-point/list — получите список пунктов возвратов для обновления склада.
/v1/warehouse/archive — перенесите склад в архив.
/v1/warehouse/operation/status — получите статус архивации склада.
Уберите склад из архива
/v1/warehouse/fbs/return-mile/info или /v1/warehouse/fbs/return-mile/check — проверьте необходимость установки возвратной мили.
/v1/warehouse/fbs/update/return-point/list — получите список пунктов возвратов для обновления склада.
/v1/warehouse/unarchive — уберите склад из архива.
/v1/warehouse/operation/status — получите статус разархивации склада.
Работа со складами rFBS Express
Доставка «Партнёры Ozon»
Создайте новый склад
/v1/warehouse/erfbs/aggregator/create — создайте новый склад.
/v1/warehouse/operation/status — получите статус создания склада по идентификатору операции operation_id.
/v1/delivery-method/return/settings/get — получите информацию по возвратным настройкам.
Обновите информацию о складе
/v1/warehouse/erfbs/update — обновите информацию о складе.
/v1/warehouse/erfbs/aggregator/delivery-method/update — обновите информацию о методе доставки.
/v1/warehouse/operation/status — получите статус изменения информации по идентификатору операции operation_id.
Доставка «Вы или сторонняя служба»
Создайте новый склад
/v1/warehouse/erfbs/non-integrated/create — создайте новый склад.
/v1/warehouse/operation/status — получите статус создания склада по идентификатору операции operation_id.
/v1/delivery-method/return/settings/get — получите информацию по возвратным настройкам.
Привяжите полигоны доставки к складу
/v1/polygon/create — создайте полигон доставки.
/v2/polygon/bind — привяжите полигон к методу доставки на складе.
Обновите информацию о складе
/v1/warehouse/erfbs/update — обновите информацию о складе.
/v1/warehouse/erfbs/non-integrated/delivery-method/update — обновите информацию о методе доставки.
/v1/warehouse/operation/status — получите статус изменения информации по идентификатору операции operation_id.
Обновите информацию о полигонах доставки
/v1/polygon/list — получите список полигонов доставки, которые привязаны к складу.
/v1/polygon/delete — удалите полигон из области доставки.
/v1/polygon/time/coordinates/update — обновите координаты полигона доставки.
/v1/polygon/time/set — обновите время доставки в полигоне.
Управляйте заказами FBO, FBS, rFBS и FBP
Обработайте заказы в зависимости от схемы работы:

cхема FBO;
стандартная схема FBS;
схема FBS PickUp с подключённой доверительной приёмкой;
Ozon Доставка;
стандартная схема rFBS;
схема rFBS Express с доставкой в пункт выдачи;
схема rFBS с доставкой через интегрированную службу;
схема rFBS Агрегатор.
Если вы продаёте товары из-за рубежа, обрабатывайте заказы по одной из схем:

rFBS Crossborder;
rFBS Crossborder с интегрированной службой доставки;
rFBS Агрегатор;
схема FBP.
...
/v1/cluster/list или /v2/cluster/list — получите информацию по кластерам и их складам.

Создайте черновик заявки на поставку:

/v1/draft/direct/create — прямую;
/v1/draft/crossdock/create — кросс-докингом;
/v1/draft/multi-cluster/create — для нескольких кластеров.
Если вы выбрали поставку кросс-докингом или в несколько кластеров, укажите схему доставки:

Drop-off — заполните параметры delivery_info.drop_off_warehouse.warehouse_id и delivery_info.drop_off_warehouse.warehouse_type. Получите значения параметров методом /v1/warehouse/fbo/list.
Pick-up — заполните параметр delivery_info.seller_warehouse_id. Получите значение параметра методом /v1/warehouse/fbo/seller/list.
/v2/draft/create/info — получите статус создания черновика и информацию по нему.

/v2/draft/timeslot/info — получите доступные таймслоты для конечных складов отгрузки. Максимальный период — 28 дней, начиная с текущей даты.

/v2/draft/supply/create — создайте заявку на поставку по черновику.

/v2/draft/supply/create/status — получите статус создания заявки на поставку. Когда заявка будет создана, метод вернёт идентификаторы заявок на поставку.
...
/v3/supply-order/list — получите список заявок на поставку.
/v1/supply-order/status/counter — получите статус заявки и количество поставок в этом статусе.
/v3/supply-order/get — получите информацию по заявке.
/v1/supply-order/bundle — получите состав поставки или заявки на поставку.
Для проезда на фулфилмент выберите интервал поставки и оформите пропуск для водителя и автомобиля. Для этого:

/v1/supply-order/timeslot/get — получите список доступных интервалов.
/v1/supply-order/timeslot/update — измените выбранный интервал.
/v1/supply-order/timeslot/status — получите статус закрепления интервала.
/v1/supply-order/pass/create — добавьте данные водителя и автомобиля.
/v1/supply-order/pass/status — получите статус ввода данных о водителе и автомобиле.
Управляйте грузоместами в заявке на поставку
/v1/cargoes/create — передайте количество грузомест и установите в каждое грузоместо товарный состав.
/v2/cargoes/get — получите информацию о грузоместах.
/v2/cargoes/create/info — получите информацию по установке грузомест и товарного состава.
/v1/cargoes-label/create — создайте задание на формирование этикеток грузомест.
/v1/cargoes-label/get — получите статус создания этикеток и идентификатор файла с ними.
/v1/cargoes/rules/get — получите чек-лист с правилами по установке грузомест.
Распределите товары по транспортным грузоместам FBO
/v1/cargoes/transport/activate — включите транспортные грузоместа в поставке.
/v1/cargoes/transport/activate/status — получите статус включения транспортных грузомест.
/v1/cargoes/transport/create — создайте транспортные грузоместа.
/v1/cargoes/transport/create/status — получите статус создания транспортного грузоместа.
/v2/cargoes/get — получите информацию о грузоместах.
/v1/cargoes/create — передайте количество грузомест и установите в каждое грузоместо товарный состав.
/v2/cargoes/create/info — получите информацию об установке грузомест и товарного состава.
/v1/cargoes-label/create — сгенерируйте этикетки для грузомест. Вы можете получать этикетки после создания каждого грузоместа или когда создадите все необходимые грузоместа.
/v1/cargoes-label/get — получите статус создания этикеток и идентификатор файла с ними.
/v1/cargoes/transport/bind — привяжите грузоместа к транспортным грузоместам.
/v1/cargoes/transport/bind/status — получите статус связывания грузомест и транспортных грузомест.
/v1/cargoes/supplies/get — получите информацию о грузоместах в поставках. Вы можете проверить полноту загрузки транспортных грузомест и проверить, все ли грузоместа привязаны к транспортным грузоместам. Если привязаны не все, привяжите оставшиеся.
Чтобы удалить грузоместа или транспортные грузоместа, используйте метод /v2/cargoes/delete. Чтобы получить информацию о статусе их удаления — метод /v2/cargoes/delete/status.

Чтобы перераспределить грузоместа по транспортным грузоместам, используйте:

/v1/cargoes/supplies/get — получите информацию о текущем распределении грузомест в поставках.
/v2/cargoes/get — получите информацию о грузоместах.
/v1/cargoes/transport/bind — отвяжите грузоместа от транспортных грузомест.
/v1/cargoes/transport/bind/status — получите статус отвязывания грузомест и транспортных грузомест.
/v1/cargoes/transport/create — создайте транспортные грузоместа.
/v1/cargoes/transport/create/status — получите статус создания транспортного грузоместа.
/v1/cargoes/transport/bind — привяжите грузоместа к транспортным грузоместам.
/v1/cargoes/transport/bind/status — получите статус связывания грузомест и транспортных грузомест.
...
все этикетки по заявке — используйте /v1/cargoes/label/transport-by-order/create, чтобы сгенерировать этикетки для транспортных грузомест по идентификатору поставки, и /v1/cargoes/label/transport-by-order/status, чтобы получить статус генерации таких этикеток;
этикетки для конкретных транспортных грузомест — используйте /v1/cargoes/label/transport/create, чтобы сгенерировать этикетки транспортных грузомест по идентификатору грузоместа, и /v1/cargoes/label/transport/status, чтобы получить статус генерации таких этикеток.
Чтобы получить чек-лист с правилами по установке грузомест, используйте /v1/cargoes/rules/get.
...
Проверьте, что коды маркировки соответствуют требованиям системы «Честный ЗНАК» по составу и количеству символов: /v5/fbs/posting/product/exemplar/validate.

Получите идентификаторы экземпляров exemplar_id методом /v6/fbs/posting/product/exemplar/create-or-get.

С помощью метода /v6/fbs/posting/product/exemplar/set добавьте для каждого экземпляра маркировку, которую будете передавать в систему «Честный ЗНАК». При необходимости передайте номера таможенных деклараций и регистрационные номера партии товара или укажите, что их нет.

Подробнее о маркировке «Честный ЗНАК» в Базе знаний

Получите статусы передачи маркировок:

/v5/fbs/posting/product/exemplar/status — получить статус добавления экземпляров.
/v6/fbs/posting/product/exemplar/create-or-get — получить данные созданных экземпляров.
...
Запросите информацию о созданной поставке с помощью метода /v1/carriage/get. Массив available_actions содержит информацию о доступных действиях с поставкой и необходимости создать пропуск для проезда на склад Ozon.
...
Получите список перевозок, по которым нужно распечатать штрихкод для отгрузки и транспортную накладную: /v1/posting/carriage-available/list или /v2/carriage/delivery/list.
...
Получите PDF-документы: /v2/posting/fbs/act/get-pdf и /v1/carriage/act-discrepancy/pdf.
...
Создайте эконом-товары в личном кабинете.
Получите идентификаторы квантов с созданными товарами: /v1/product/quant/list.
...
Отфильтруйте прослеживаемые отправления, используя фильтр is_blr_traceable = true: /v3/posting/fbs/list.
...
Получите список нулевых отгрузок: /v2/carriage/delivery/list. Прослеживаемые отгрузки будут иметь признак all_blr_traceable.
...
Ozon Доставка
Доставка
v1/delivery/check — проверьте, может ли покупатель получить заказ через Ozon. Способы доставки для Ozon Доставки:
...
Если способ доставки — самовывоз, передайте идентификатор точки самовывоза в параметр pickup. При курьерской доставке передайте адрес получения и координаты в параметр courier.
...
v2/order/create — создайте заказ и начните сборку. После вызова метода изменить заказ не получится.
v2/posting/fbo/list и v3/posting/fbs/list — отследите все отправления или конкретное.
v1/posting/marks — получите маркировки экземпляров из отправления. Передавайте в этот метод только отправления, которые вы создали через методы Ozon Доставки.
Отслеживание отправлений
Для схемы FBO:

v2/posting/fbo/list — получите список всех отправлений.
v2/posting/fbo/get — получите информацию о конкретном отправлении.
Для схемы FBS:

v3/posting/fbs/unfulfilled/list — получите список необработанных отправлений.
v3/posting/fbs/list — получите список отправлений.
v3/posting/fbs/get — получите информацию об отправлении.
...
/v1/cancel-reason/list-by-order — получите возможные причины отмены заказа.
/v1/cancel-reason/list-by-posting — получите список доступных причин отмены отправления. Используйте метод, только если покупатель запросил отмену заказа.
v1/order/cancel/check — проверьте, можно ли отменить заказ.
v1/order/cancel — отмените заказ.
v1/posting/cancel — отмените отправление из заказа.
v1/order/cancel/status — проверьте статус отмены заказа.
v1/posting/cancel/status — проверьте статус отмены отправления.
Для отмены FBS-отправлений:

v2/posting/fbs/product/cancel — отмените отправку некоторых товаров в отправлении.
v2/posting/fbs/cancel — отмените отправление.
Возврат товара
...
Остатки
v1/analytics/stocks — получите отчёт по остаткам на складах Ozon, чтобы планировать поставки товаров.
v4/product/info/stocks — покажите покупателю количество товаров на складах Ozon.
Если на складах Ozon недостаточно товаров, создать заказ через методы Ozon Доставки не получится.

Схема rFBS Стандарт
С 11 марта 2024 года максимальный срок доставки до покупателя — 30 дней. Обновите срок в настройках вашего метода. Если срок будет больше максимального, он поменяется автоматически.
...
Если вы не составляете маршрутный лист и курьер сразу направляется к покупателю, можете сразу перевести отправление из статуса «Доставляется» в «Последняя миля»: /v2/fbs/posting/last-mile.
...
on_way_to_city — курьер забрал заказ.
on_way_to_pickup_point — курьер везёт заказ в пункт выдачи.
in_pickup_point — отправление приняли в пункте выдачи.
delivered — покупатель забрал заказ из пункта выдачи.
...
Когда перевозчик обработает отправление, его статус изменится с awaiting_registration на awaiting_delivery. После этого отправлению будет присвоен трек-номер.
...
После передачи отправления в службу доставки измените статус отправления на delivering — «Доставляется»: /v2/fbs/posting/delivering.
...
Перед тем, как перевести заказ с весовыми товарами в статус «Ожидает отгрузки» — awaiting_delivery, передайте уточнённые данные о весе товаров. Для этого после взвешивания перед сборкой передайте информацию о весе каждого экземпляра весовых товаров через метод /v6/fbs/posting/product/exemplar/set.
...
Если в методе /v3/posting/fbs/get в параметре result.products.is_weight_needed для товара указано значение true, взвесьте товар.
...
Если в заказе с весовыми товарами есть невзвешенные товары, при вызове метода /v4/posting/fbs/ship вернётся ошибка WEIGHT_IS_REQUIRED.
...
/v1/supply-order/bundle — получите информацию по товарному составу с помощью bundle_id.
...
/v1/fbp/warehouse/list — получите список партнёрских складов.
/v1/fbp/draft/drop-off/product/validate — проверьте, может ли склад партнёра принять товары.
/v1/fbp/draft/drop-off/province/list — получите список провинций.
/v1/fbp/draft/drop-off/point/list — получите список пунктов в провинции.
/v1/fbp/draft/drop-off/point/timetable — получите расписание пункта.
/v1/fbp/draft/drop-off/create — создайте черновик для drop-off доставки.
/v1/fbp/draft/drop-off/dlv/edit — измените детали drop-off доставки для черновика.
/v1/fbp/draft/list — получите список черновиков.
/v1/fbp/draft/get — получите информацию о конкретном черновике поставки. Если в черновике есть ошибка, используйте /v1/fbp/draft/drop-off/delete, чтобы удалить его.
/v1/supply-order/bundle — получите информацию по товарному составу с помощью bundle_id.
/v1/fbp/draft/drop-off/registrate — переведите черновик заявки на поставку в активную заявку.
/v1/fbp/order/drop-off/timetable — получите график работы drop-off пункта.
/v1/fbp/order/drop-off/dlv/edit — отредактируйте и передайте информацию о доставке на drop-off пункт.
/v1/fbp/order/list — получите список поставок.
/v1/fbp/order/get — получите информацию о конкретной поставке. Если в заявке на поставку есть ошибка, используйте /v1/fbp/order/drop-off/cancel, чтобы отменить поставку.
/v1/fbp/label/create — создайте задание на генерацию этикеток.
/v1/fbp/label/get — получите этикетки и статус задания на их генерацию.
/v1/fbp/act-to/create — создайте задание на генерацию транспортной накладной.
/v1/fbp/act-to/get — получите транспортную накладную и статус задания на её генерацию.
...
/v1/fbp/warehouse/list — получите список партнёрских складов.
/v1/fbp/draft/pick-up/product/validate — проверьте, может ли склад партнёра принять товары.
/v1/fbp/draft/pick-up/create — создайте черновик для pick-up доставки.
/v1/fbp/draft/pick-up/dlv/edit — измените детали pick-up доставки для черновика.
/v1/fbp/draft/list — получите список черновиков.
/v1/fbp/draft/get — получите информацию о конкретном черновике поставки. Если в черновике есть ошибка, используйте /v1/fbp/draft/pick-up/delete, чтобы удалить его.
/v1/supply-order/bundle — получите информацию по товарному составу с помощью bundle_id.
/v1/fbp/draft/pick-up/registrate — переведите черновик заявки на поставку в активную заявку.
/v1/fbp/order/pick-up/dlv/edit — измените информацию о pick-up пункте.
/v1/fbp/order/list — получите список поставок.
/v1/fbp/order/get — получите информацию о конкретной поставке. Если в заявке на поставку есть ошибка, используйте /v1/fbp/order/pick-up/cancel, чтобы отменить поставку.
/v1/fbp/label/create — создайте задание на генерацию этикеток.
/v1/fbp/label/get — получите этикетки и статус задания на их генерацию.
/v1/fbp/act-to/create — создайте задание на генерацию транспортной накладной.
/v1/fbp/act-to/get — получите транспортную накладную и статус задания на её генерацию.
...
/v2/posting/fbs/act/list — получите список сформированных ранее актов.
/v2/posting/fbs/act/get-postings — получите список отправлений по каждому акту.
...
/v1/return/giveout/get-pdf — получить штрихкод в формате PDF.
/v1/return/giveout/get-png — получить штрихкод в формате PNG.
/v1/return/giveout/barcode — получить штрихкод в текстовом виде.
Получите информацию и список возвратных отгрузок:

/v1/return/giveout/list — получить список возвратных отгрузок.
/v1/return/giveout/info — получить информацию о выбранной отгрузке.
...
/v2/returns/rfbs/get — получите информацию по заявке на возврат rFBS.
/v2/returns/rfbs/list — получите список заявок на возврат rFBS.
Вы можете одобрить, компенсировать, подтвердить возврат денег, запросить товар для проверки и отклонить заявку методом /v1/returns/rfbs/action/set. Для передачи корректного action получите список доступных для конкретного возврата, в методе /v2/returns/rfbs/get.

Управляйте заявками на отмену
Получите заявки и информацию о них: /v2/conditional-cancellation/list.

Примите решение по новой заявке на отмену — подтвердите или отклоните её:

/v2/conditional-cancellation/approve — подтвердите заявку на отмену rFBS. Заказ будет автоматически отменён, а деньги вернутся покупателю.
/v2/conditional-cancellation/reject — отклоните заявку на отмену rFBS. Заказ останется в том же статусе, и его нужно будет доставить покупателю.
Управляйте чатами
...
Ответы
200Информация о кабинете продавца
Response Schema: application/json
company	
object
Компания.
...
Ответы
200Информация о подключении Ozon Доставки
Response Schema: application/json
available_schemas	
Array of strings
Default: "UNKNOWN"
Items Enum: "UNKNOWN" "FBO" "FBS"
Тип доступной схемы:
...
Ответы
200Справочные значения характеристики.
Response Schema: application/json
result	
Array of objects
Значения характеристики.
...
Подробнее о зонах размещения в Базе знаний продавца

Request Body schema: application/json
skus
required
Array of strings <int64> [ 1 .. 150 ] items
Список идентификаторов товаров в системе Ozon — SKU.

Ответы
200Информация о зонах размещения
Response Schema: application/json
products_placement	
Array of objects
Список товаров с их зонами размещения.

Array ()
placement_zone	
string
Default: "UNSPECIFIED"
Enum: "UNSPECIFIED" "CLOSED_ZONE" "DANGEROUS_GOODS" "PRODUCTS" "SORT" "NON_SORT" "OVERSIZE" "JEWELRY" "UNRESOLVED"
...
Проверьте, что в ответе метода /v1/description-category/attribute возвращается характеристика с result.id = 23500.
Передайте ссылку на изображение в параметре items.attributes.values.value с id = 23500.
...
Ответы
200Создан новый товар / Информация о товаре обновлена
Response Schema: application/json
result	
object
Результаты запроса.
...
task_id	
integer <int64>
Номер задания на загрузку товаров. Проверьте статус создания или обновления товара методом /v1/product/import/info.
...
application/json
Example
Пример запроса без загрузки видео
{
"items": [
{
"attributes": [
...
Ответы
200Статус добавления или обновления товара
Response Schema: application/json
result	
object
items	
...
Item-Retry-After — время в минутах до обновления лимита. Для суточного лимита — время до 03:00 по московскому времени.
Item-Rate-Limit-Remaining — остаток операций до следующего сброса лимита.
Чтобы узнать лимит, используйте /v4/product/info/limit.
...
Ответы
200Создано задание на обновление товаров
Response Schema: application/json
task_id	
integer <int64>
...
Если вы обновили изображение по ссылке, но ссылка не изменилась, в методе /v1/product/import/info для изображения в параметре result.items.status вернётся skipped.
...
images	
Array of strings
Массив ссылок на изображения. До 30 штук. Изображения в массиве расположены в порядке их расположения на сайте. Первое изображение в массиве будет главным.
...
Ответы
200Предварительный результат работы метода
Response Schema: application/json
result	
object
...
Если вы используете фильтр по идентификатору offer_id или product_id, остальные параметры заполнять не обязательно. Вернутся все товары с указанными идентификаторами, независимо от видимости. За один раз вы можете использовать только одну группу идентификаторов, не больше 1000 товаров.
...
Подробнее о супер-товарах в Базе знаний продавца
...
desc — по убыванию.
Ответы
200Описание характеристик товара
Response Schema: application/json
result	
Array of objects
Результаты запроса.
...
Ответы
200Лимиты на ассортмент, создание и обновление товаров
Response Schema: application/json
daily_create	
object
...
operation_limits	
object
Доступный лимит на работу с товарами.
...
Подробнее о требованиях к артикулам в Базе знаний продавца
...
Ответы
200Информация об изменении артикулов
Response Schema: application/json
errors	
Array of objects
Список ошибок.
...
Чтобы проверить фактическое состояние товара после архивации, используйте метод /v3/product/info/list.
Подробнее об управлении товарами в архиве в Базе знаний продавца
...
required
Array of integers <int64>
Список идентификаторов товаров в системе Ozon — product_id. Вы можете передать до 100 идентификаторов за раз.
...
В сутки можно восстановить из архива не больше 100 товаров, которые были архивированы автоматически.
Лимит обновляется в 03:00 по московскому времени. На разархивацию товаров, перенесённых в архив вручную, ограничений нет.

Ответы
200Товар из архива возвращён
Response Schema: application/json
result	
boolean
Результат обработки запроса. true, если запрос выполнен без ошибок.
...
Ответы
200Количество подписавшихся пользователей
Response Schema: application/json
result	
Array of objects
Результат работы метода.
...
Подробнее об объёмно-весовых характеристиках в Базе знаний продавца
...
Ответы
200Информация о товарах с некорректными ОВХ
Response Schema: application/json
cursor	
string
Указатель для выборки следующих данных.
...
skus	
Array of strings <int64> <= 1000
Идентификатор товаров в системе Ozon — SKU.

Ответы
200Информация о стоках.
Response Schema: application/json
cursor	
string
Указатель для выборки следующих данных.
...
Описание и примерыКонсоль
Если у товара есть штрихкод, который не указан в системе Ozon, привяжите его с помощью этого метода. Чтобы сгенерировать штрихкод, используйте метод /v1/barcode/generate.
Подробнее о требованиях к штрихкодам в Базе знаний продавца
...
Ответы
200Количество товаров обновлено
Response Schema: application/json
result	
Array of objects
Array ()
...
Ответы
200Количество товара на складе FBS и rFBS
Response Schema: application/json
cursor	
string
...
true — сделайте повторный запрос с другим значением cursor, чтобы получить остальные значения;
false — ответ содержит все значения.
stocks	
Array of objects
Информация об остатках товара.
...
Ответы
200Количество товаров на складах
Response Schema: application/json
cursor	
string
Указатель для выборки следующих данных.
...
Ответы
200Количество товаров на складах FBS и rFBS
Response Schema: application/json
result	
Array of objects
Результат работы метода.
...
product_id	
integer <int64>
Идентификатор товара в системе Ozon — артикул.
...
expired_at	
string <date-time>
Время окончания таймера. Если параметр пустой, активного таймера нет.
...
Ответы
200Информация об уценке и основном товаре
Response Schema: application/json
items	
Array of objects
...
Ответы
200Ошибки при добавлении товаров
Response Schema: application/json
result	
object
Результат работы метода.
...
Ответы
200Ошибки при удалении товаров
Response Schema: application/json
result	
object
Результат работы метода.
...
Подробнее о работе с брендами в Базе знаний продавца
...
Ответы
200Cправочник типов соответствия требованиям
Response Schema: application/json
result	
Array of objects
...
Ответы
200Список типов соответствия требованиям
Response Schema: application/json
result	
object
...
Ответы
200Справочник типов документов
Response Schema: application/json
result	
Array of objects
Список типов и названий сертификатов.
...
Ответы
200Список сертифицируемых категорий
Response Schema: application/json
certification	
Array of objects
...
required
string
Enum: "certificate_of_conformity" "declaration" "certificate_of_registration" "registration_certificate" "refused_letter" "veterinary_cover_document" "safety_data_sheet"
...
Тип соответствия требованиям. Чтобы получить доступные типы, используйте метод GET /v1/product/certificate/accordance-types. Параметр обязательный, если type_code = declaration, certificate_of_conformity или safety_data_sheet.
...
Ответы
200Идентификатор загруженного сертификата
Response Schema: application/json
integer
400Неверный параметр
403Доступ запрещён
...
Ответы
200Сертификат привязан к товару
Response Schema: application/json
result	
boolean
Результат обработки запроса. true, если запрос выполнен без ошибок.
...
Ответы
200Результат удаления сертификата
Response Schema: application/json
result	
object
...
Ответы
200Товар отвязан от сертификата
Response Schema: application/json
result	
Array of objects
Результат работы метода.
...
Ответы
200Причины отклонения сертификата
Response Schema: application/json
result	
Array of objects
...
Ответы
200Возможные статусы сертификатов
Response Schema: application/json
result	
Array of objects
...
boolean
true, если можно установить цену.
...
required
integer <int64>
Идентификатор способа доставки. Получите значение параметра методом /v2/delivery-method/list.

Ответы
200Информация получена
Response Schema: application/json
settings	
object
...
post_office_zipcode	
string
Индекс отделения Почты России для «лёгкого возврата».

transport_company_details	
object
Настройки транспортной компании.
...
entity_id	
integer <int64>
Идентификатор обрабатываемой сущности. Если операция CREATE_FBS_WAREHOUSE, вернётся идентификатор склада.

status	
string
Default: "UNSPECIFIED"
Enum: "UNSPECIFIED" "IN_PROGRESS" "SUCCESS" "ERROR"
Статус операции:
...
string
Default: "UNSPECIFIED"
Enum: "UNSPECIFIED" "CREATE_FBS_WAREHOUSE" "UPDATE_FBS_WAREHOUSE" "SET_FIRST_MILE" "WAREHOUSE_ENABLE_DISABLE" "WAREHOUSE_PAUSE_UNPAUSE"
Тип операции:

UNSPECIFIED — не определено;
CREATE_FBS_WAREHOUSE — создание FBS-склада;
UPDATE_FBS_WAREHOUSE — обновление FBS-склада;
SET_FIRST_MILE — установка первой мили;
WAREHOUSE_ENABLE_DISABLE — архивация или разархивация FBS-склада;
WAREHOUSE_PAUSE_UNPAUSE — включение или выключение паузы rFBS-склада.
defaultОшибка
Примеры запроса
Content type
application/json
...
return_point_id	
integer <int64>
Идентификатор пункта возврата. Получите значение параметра методом /v1/warehouse/fbs/update/return-point/list.
...
Ответы
200Склад перенесён в архив
Response Schema: application/json
operation_id	
string
Идентификатор операции. Получите статус операции методом /v1/warehouse/operation/status.
...
required
integer <int64>
Идентификатор склада. Получите значение параметра методом /v1/warehouse/warehouses-with-invalid-products.

Ответы
200Список товаров с ограничениями
Response Schema: application/json
has_next	
boolean
true, если в ответе вернулись не все товары.
...
warehouse_ids	
Array of strings <int64>
Список идентификаторов складов, у которых есть хотя бы 1 товар, который недоступен для доставки со склада. Чтобы получить список товаров с ограничениями, используйте метод /v1/warehouse/invalid-products/get.
...
coordinates	
object
Координаты drop-off пункта.

discount_percent	
number <float>
Процент скидки за передачу отправления.
...
string
Местное время окончания приёма заказа.

acceptance_start_time_local	
string
Местное время начала приёма заказа.
...
is_pickup_supported	
boolean
Признак поддержки отгрузки pick-up.
...
required
integer <int64>
Время на приём заказов в минутах. Например, если вы передадите 3000, приём заказов будет завершён через 50 часов с момента передачи.
...
PICK_UP — отгрузка заказов курьеру;
DROP_OFF — отгрузка заказов в пункт приёма.
is_kgt
required
boolean
true, если товар крупногабаритный.
...
return_point_id	
integer <int64>
Идентификатор пункта возврата. Получите значение параметра методом /v1/warehouse/fbs/create/return-point/list.

working_days	
Array of strings <= 7 items
...
operation_id	
string
Идентификатор операции на создание FBS-склада. Чтобы получить статус операции, используйте метод /v1/warehouse/operation/status.
...
has_next	
boolean
Признак, что в ответе вернули не все пункты возврата.

is_selected_point_available	
boolean
Признак доступности пункта возврата.
...
integer <int64>
Установленный пункт возврата. Получите значение параметра методом /v1/warehouse/fbs/return-mile/info.
...
is_selected_point_available	
boolean
Признак доступности пункта возврата для выбора.
...
Array of objects
Информация о возвратной миле на складе.

Array ()
is_return_mile_required	
boolean
Признак, что необходимо установить пункт возврата.
...
200Успешно
Response Schema: application/json
should_set_return_mile	
boolean
Признак, что необходимо установить возвратную милю.

unavailability_reasons	
Array of strings
Причины, по которым нельзя установить возвратную милю.
...
Подробнее об отгрузках курьеру на FBS в Базе знаний
...
Чтобы получить список складов для планирования выездов, используйте /v1/warehouse/fbs/pickup/planning/list.
...
Описание и примерыКонсоль
Чтобы создать отгрузку, используйте метод /v1/warehouse/fbs/pickup/courier/create.
...
boolean
Default: true
true, если номер телефона курьера совпадает с номером телефона склада.

Если is_courier_phone_same_as_warehouse = true, текущий номер телефона будет указан в courier_phones.

courier_phones	
Array of strings <= 3 items +7(XXX)XXX-XX-XX
Номера телефонов для связи с курьером.

cut_in	
integer <int64>
Enum: 15 30 60 120 180 240 300 360 420 480
Время сборки.
...
Используйте фильтр по времени сборки — cutoff или по дате передачи отправления в доставку — delivering_date. Если использовать их вместе, в ответе вернётся ошибка.
...
"delivery_method": {
"id": 20605650762000,
"name": "Доставка Ozon самостоятельно, Софьино",
"warehouse_id": 20605650762000,
"warehouse": "17023",
"tpl_provider_id": 24,
...
"name": "Кроссовки для мальчика демисезонные из натуральной кожи",
"sku": 4116250392,
"quantity": 1,
"imei": [ ],
"weight": 0.549,
...
"destination_place_name": "ПВЗ №123 на Тверской",
"external_order": {
"is_external": false,
"platform_name": ""
},
...
sorting_center	
object
Информация о сортировочном центре, в который нужно привезти отправление. Для integration_type_flow = hybrid_3pl_tracking. Если значение null, информацию получить не удалось.
...
Ответы
200Список доступных стран-изготовителей
Response Schema: application/json
result	
Array of objects
...
Ответы
200Страна-изготовитель добавлена
Response Schema: application/json
product_id	
integer <int64>
Идентификатор товара в системе Ozon — product_id.
...
Описание и примерыКонсоль
Если вы работаете по схеме rFBS или rFBS Express, изучите процесс печати этикетки в Базе знаний продавца.
Метод для создания задания на асинхронное формирование этикеток для отправлений в статусе «Ожидает отгрузки» — awaiting_deliver. Метод может вернуть несколько заданий: на формирование маленькой и большой этикетки.
...
Ответы
200Задания на формирование этикеток
Response Schema: application/json
result	
object
Результат работы метода.
...
Ответы
200Идентификатор задания на формирование этикеток
Response Schema: application/json
result	
object
Результат работы метода.
...
Ответы
200Статус формирования этикеток или файл с ними
Response Schema: application/json
result	
object
Результат работы метода.
...
unprinted_postings	
Array of objects
Информация об ошибках, из-за которых не получилось напечатать этикетки.

unprinted_postings_count	
integer <int32>
Количество этикеток, которые не получилось напечатать.
...
Ответы
200Отправление передано к отгрузке
Response Schema: application/json
result	
boolean
Результат обработки запроса. true, если запрос выполнился без ошибок.
...
Ответы
200Список неоплаченных товаров
Response Schema: application/json
products	
Array of objects
...
coordinates	
string
Координаты полигона доставки в формате [[[lat,long],[lat,long]]].
...
Ответы
200Статус заявки и количество заявок в этом статусе
Response Schema: application/json
items	
Array of objects
Array ()
...
Идентификаторы товарного состава поставки. Можно получить в методе /v3/supply-order/get.
...
required
string
Enum: "ORDER_CREATION" "ORDER_STATE_UPDATED_AT" "TIMESLOT_FROM_UTC" "TIMESLOT_FROM_LOCAL"
Параметр, по которому заявки на поставку будут отсортированы:
...
order_ids
required
Array of strings <int64> <= 50 items
Идентификаторы заявок на поставку.

Ответы
200Информация о заявке
Response Schema: application/json
orders	
Array of objects
...
string
Default: "UNSPECIFIED"
Enum: "UNSPECIFIED" "DATA_FILLING" "READY_TO_SUPPLY" "ACCEPTED_AT_SUPPLY_WAREHOUSE" "IN_TRANSIT" "ACCEPTANCE_AT_STORAGE_WAREHOUSE" "REPORTS_CONFIRMATION_AWAITING" "REPORT_REJECTED" "COMPLETED" "REJECTED_AT_SUPPLY_WAREHOUSE" "CANCELLED" "OVERDUE"
...
state_updated_date	
string <date-time>
Дата обновления статуса заявки на поставку.
...
limit_exceeded	
object
Информация о превышении лимита изменений интервала поставки.

timeslot_change_forbidden	
object
Информация о причинах, по которым нельзя изменить интервал поставки.

timeslots_info	
object
Информация об интервалах поставки.
...
UPDATE_TIMESLOT_ERROR_PICKUP_ORDER_LIMIT_EXCEEDED — превышен суточный лимит на создание заявок на поставку курьером;
UPDATE_TIMESLOT_ERROR_LIMIT_OF_CHANGING_TIMESLOT_EXCEEDED — превышен лимит изменения интервала доставки.
operation_id	
string
Идентификатор операции.
...
Ответы
200Подробная информация о заявке
Response Schema: application/json
created_date	
string <date-time>
Дата создания заявки на поставку.
...
Ответы
200Информация о загруженности складов
Response Schema: application/json
result	
Array of objects
Результат работы метода.
...
Default: "PARTIAL"
Enum: "PARTIAL" "FULL"
Режим удаления SKU, которые не попали в поставку.
...
draft_id	
integer <int64>
Идентификатор черновика. Используйте в методе /v2/draft/create/info.
...
required
integer <int64>
Идентификатор черновика из методов /v1/draft/crossdock/create, /v1/draft/direct/create или /v1/draft/multi-cluster/create.

Ответы
200Информация о черновике
Response Schema: application/json
clusters	
Array of objects
Кластеры.
...
string
Default: "UNSPECIFIED"
Enum: "UNSPECIFIED" "SUCCESS" "IN_PROGRESS" "FAILED"
...
required
string YYYY-MM-DD
Дата окончания периода доступных таймслотов.
...
required
integer <int64>
Идентификатор черновика из метода /v2/draft/create/info.

supply_type
required
string
Enum: "CROSSDOCK" "DIRECT" "MULTI_CLUSTER"
Тип поставки:

CROSSDOCK — кросс-докинг;
DIRECT — прямая;
MULTI_CLUSTER — для нескольких кластеров.
selected_cluster_warehouses
required
Array of objects <= 20 items
Информация о кластере и складах в нём. Можно передать один кластер для кросс-докинговой и прямой поставки или список всех кластеров для поставки в несколько кластеров.
...
string
Default: "UNSPECIFIED"
Enum: "UNSPECIFIED" "INVALID_CLUSTERS_COUNT" "REQUESTED_PERIOD_MORE_THAN_MAX" "UNDEFINED"
Причина ошибки:

UNSPECIFIED — не определена;
INVALID_CLUSTERS_COUNT — переданы не все кластеры из расчёта;
REQUESTED_PERIOD_MORE_THAN_MAX — превышен период;
INVALID_REQUESTED_CLUSTER_IDS — переданы кластеры, которых нет в расчёте.
...
required
integer <int64>
Идентификатор поставки. Можно получить с помощью метода /v3/supply-order/get. Нужное значение — в параметре ответа orders.supplies.supply_id.

Ответы
200Грузоместа установлены
Response Schema: application/json
operation_id	
string
Идентификатор операции.
...
string
Default: "STATUS_UNSPECIFIED"
Enum: "STATUS_UNSPECIFIED" "SUCCESS" "IN_PROGRESS" "FAILED"
Статус формирования грузоместа:
...
supply_ids
required
Array of strings <int64> <= 100 items
Список идентификаторов поставок в заявке.

Ответы
200Информация о грузоместах
Response Schema: application/json
supply	
Array of objects
Информация о грузоместах.
...
Ответы
200Чек-лист по установке грузомест
Response Schema: application/json
supply_check_lists	
Array of objects
...
file_url	
string
Ссылка на PDF-файл с этикетками.
...
Ответы
200Отмена заявки на поставку в процессе
Response Schema: application/json
operation_id	
string
...
Ответы
200Статус отмены заявки на поставку
Response Schema: application/json
error_reasons	
Array of strings
...
MINIMUM_VOLUME_IN_LITRES_INVALID — объём товаров в поставке ниже минимального.
operation_id	
string
Идентификатор операции.
...
Ответы
200Статус редактирования
Response Schema: application/json
errors	
Array of strings
Items Enum: "INVALID_DRAFT_BUNDLE_ID" "SOME_SERVICE_ERROR" "HAS_UTD" "ORDER_SKU_LIMIT" "SAME_SKU" "SUPPLY_LOCKED" "INBOUND_NO_CAPACITY" "INBOUND_LOCK" "SUPPLY_CONTENT_NOT_VALID" "SUPPLY_BELONG_TO_ANOTHER_CONTRACTOR" "SUPPLY_BELONG_TO_ANOTHER_COMPANY" "INCORRECT_SUPPLY_STATE" "INCORRECT_SUPPLY_SOURCE" "INCORRECT_STORAGE_WAREHOUSE" "DEADLINE" "INACTIVE_CONTRACT" "QUANTITY_OUT_OF_RANGE_BOTTOM" "QUANTITY_OUT_OF_RANGE_UPPER" "EMPTY_CONTENT" "NO_SUPPLY_PRODUCT_BUNDLE_ID" "INVALID_VOLUME" "SUPPLY_IS_VIRTUAL" "ORDER_LOCKED" "MINIMUM_VOLUME_IN_LITRES_INVALID"
Список ошибок при редактировании товарного состава:
...
SUPPLY_CONTENT_NOT_VALID — в составе поставки есть товары, которые склад не может принять. Провалидируйте товарный состав методом /v1/supply-order/content/update/validation.
...
INCORRECT_SUPPLY_STATE — нельзя изменить поставку в этом статусе.
DEADLINE — нельзя изменить поставку за час до таймслота.
UTD_IS_UPLOADED — документы в системе ЭДО не удалены. Аннулируйте документы в системе ЭДО. Когда отредактируете состав, сформируйте и подпишите новые документы.
STORAGE_WAREHOUSE_IS_NOT_WMS — нельзя редактировать товарный состав.
CONTRACT_IS_NOT_VALID_FOR_HANDLING_ORDERS — в этом личном кабинете нельзя изменить поставку.
SUPPLY_IS_VIRTUAL — нельзя редактировать виртуальную поставку.
SUPPLY_DOES_NOT_BELONG_TO_COMPANY — заявка на поставку не принадлежит вашему кабинету.
ASSORTMENT_REJECTION_REASON_CORRUPTED_ASSORTMENT — не получилось добавить товар в заявку. Попробуйте ещё раз.
ASSORTMENT_REJECTION_REASON_STORAGE_BELARUS_SKU_HAS_NO_ANY_FEACN, ASSORTMENT_REJECTION_REASON_STORAGE_BELARUS_SKU_HAS_NO_SELLER_FEACN — у товара нет кода ТН ВЭД ЕАЭС.
ASSORTMENT_REJECTION_REASON_TRACEABLE_SKU_HAS_NO_GTIN_BARCODE — у товара нет штрихкода GTIN.
ASSORTMENT_REJECTION_REASON_TRACEABLE_SKU_HAS_NO_MEASUREMENT_UNIT_QUANTITY — не указано количество товара в унифицированных единицах измерения.
...
required
integer <int64>
Идентификатор черновика. Получите значение параметра методом /v2/draft/supply/create.

Ответы
200Информация о создании заявки на поставку
Response Schema: application/json
error_reasons	
Array of strings
Items Enum: "UNSPECIFIED" "SOME_SERVICE_ERROR" "ORDER_SKU_LIMIT" "INVALID_QUANTITY_OR_QUANT" "ORDER_ALREADY_CREATED" "ORDER_CREATION_IN_PROGRESS" "DRAFT_DOES_NOT_EXIST" "CONTRACTOR_CAN_NOT_CREATE_ORDER" "INACTIVE_CONTRACT" "DRAFT_INCORRECT_STATE" "INVALID_VOLUME" "INVALID_ROUTE" "INVALID_STORAGE_WAREHOUSE" "INVALID_STORAGE_REGION" "INVALID_SPLITTING" "INVALID_SUPPLY_CONTENT" "TIMESLOT_NOT_AVAILABLE" "SKU_DISTRIBUTION_REQUIRED_BUT_NOT_POSSIBLE" "XDOCK_IN_DELIVERY_POINT_DISABLED_FOR_SELLER" "DRAFT_IS_LOCKED" "INVALID_PACKAGE_UNITS_COUNTS" "SELLER_CONVERSATION_DOES_NOT_EXIST" "USER_CAN_NOT_CREATE_SELLER_CONVERSATION" "SKU_WITH_ETTN_REQUIRED_TAG_NOT_ALLOWED_FOR_DROP_OFF_POINT" "INVALID_SELLER_WAREHOUSE" "PICKUP_ORDER_LIMIT_EXCEEDED" "INVALID_CLUSTERS_COUNT" "UNDEFINED"
Причина ошибки:
...
is_active	
boolean
true, если склад активный.

is_pickup	
boolean
true, если доступна отгрузка курьером.
...
warehouse_types	
Array of strings
Items Enum: "FULL_FILLMENT" "FULL_FILLMENT_RETURNS" "FULL_FILLMENT_DEFECT" "EXPRESS_DARK_STORE" "CROSS_DOCK" "SORTING_CENTER" "PHARMACY" "DISTRIBUTION_CENTER" "ORDERS_RECEIVING_POINT" "OUTSOURCE_FF" "B2B" "EXTERNAL_FF"
Тип склада Ozon:

FULL_FILLMENT — фулфилмент;
FULL_FILLMENT_RETURNS — склад возвратов;
FULL_FILLMENT_DEFECT — склад брака;
EXPRESS_DARK_STORE — фреш;
CROSS_DOCK — кросс-док;
SORTING_CENTER — сортировочный центр;
PHARMACY — склад аптеки;
DISTRIBUTION_CENTER — распределительный центр;
ORDERS_RECEIVING_POINT — пункты приёма заказов;
OUTSOURCE_FF — аутсорс-склады;
B2B — B2B-склад;
EXTERNAL_FF — склады партнёров.
Ответы
200Список складов Ozon
Response Schema: application/json
warehouses	
Array of objects
Список складов.
...
string
Default: "UNSPECIFIED"
Enum: "UNSPECIFIED" "FULL_FILLMENT" "FULL_FILLMENT_RETURNS" "FULL_FILLMENT_DEFECT" "EXPRESS_DARK_STORE" "CROSS_DOCK" "SORTING_CENTER" "PHARMACY" "DISTRIBUTION_CENTER" "ORDERS_RECEIVING_POINT" "OUTSOURCE_FF" "B2B" "EXTERNAL_FF"
Тип склада:
...
is_cross_dock	
boolean
true, если тип склада — кросс-док.

is_distribution_center	
boolean
true, если тип склада — распределительный центр.
...
Чтобы внести информацию по экземплярам, используйте метод /v6/fbs/posting/product/exemplar/set.
...
Ответы
200Результат сборки отправления
Response Schema: application/json
result	
string
...
Ответы
200Статусы проверки экземпляров
Response Schema: application/json
posting_number	
string
Номер отправления.
...
После подтверждения отгрузки вы можете получить лист отгрузки методом /v2/posting/fbs/act/get-pdf и штрихкод отгрузки методом /v2/posting/fbs/act/get-barcode.
...
required
integer <int64>
Идентификатор метода доставки. Для realFBS-складов получите его с помощью метода /v2/delivery-method/list. Для FBS-складов используйте значение параметра warehouse_id. Его можно получить с помощью метода /v2/warehouse/list.
...
required
integer <int64>
Фильтр по методу доставки. Можно получить с помощью метода /v2/delivery-method/list.
...
all_blr_traceable	
boolean
true, если отгрузка с прослеживаемыми товарами.
...
set_arrival_passes — оформить пропуск.
cancel_availability	
object
Возможность отмены.
...
required
int <int64>
Идентификатор акта. Получите значение параметра методом /v2/posting/fbs/act/list или /v1/carriage/create.
...
Ответы
200Этикетки для грузового места
Response Schema: application/pdf
file_content	
string <byte>
Содержание файла в бинарном виде.
...
Ответы
200Статус формирования накладной
Response Schema: application/json
id	
integer <int64>
...
Получите список доступных документов для отгрузки в параметре available_actions метода /v1/carriage/get.
...
required
integer <int64>
Номер задания на формирование документов (также идентификатор перевозки) из методов /v2/posting/fbs/act/create или /v1/carriage/create.
...
Ответы
200Статус отгрузки и документов
Response Schema: application/json
result	
object
Результат работы метода.
...
boolean
Признак, что товар потенциально прослеживаемый:

true — отправление считается прослеживаемым на данный момент. При сборке статус может измениться.
false — отправление не прослеживаемое на данный момент или его статус неизвестный.
products	
Array of objects
Список товаров в отправлении.
...
Ответы
200Список незаполненных атрибутов
Response Schema: application/json
products	
Array of objects
Список товаров в отправлении.
...
Ответы
200Статус проверки электронной ТТН
Response Schema: application/json
errors	
Array of strings
Ошибки проверки электронной ТТН на прослеживаемой отгрузке.

status	
string
Enum: "NOT_UPLOADED" "PROCESSING" "SUCCESS" "FAILED"
Статус проверки электронной ТТН на прослеживаемой отгрузке:
...
boolean
true, если можно распечатать этикетки массово.
...
offset	
integer <int64>
Количество элементов, которое будет пропущено в ответе. Например, если offset = 10, ответ начнётся с 11 найденного элемента.
...
DESC — по убыванию.
Ответы
200Список товаров в отправлениях
Response Schema: application/json
has_next	
boolean
Признак, что в ответе вернули не все товары:

true — сделайте повторный запрос с другим значением offset, чтобы получить остальные значения;
false — ответ содержит все значения.
products	
Array of objects
Список товаров.
...
Ответы
200Доступные даты и количество
Response Schema: application/json
delivery_interval	
object
...
integer <int32> [ 1 .. 1000 ]
Default: 1000
Ограничение по количеству записей в ответе.
...
Ответы
200Настройки автоутилизации
Response Schema: application/json
min_price	
object
Минимальная цена товара, с которой можно установить автоутилизацию методом /v1/returns/settings/utilization/update.

utilization_settings	
object
Настройки утилизации.
...
last_id	
integer <int32>
Идентификатор последнего значения на странице — return_id. Оставьте это поле пустым при выполнении первого запроса.
...
required
integer <int64>
Идентификатор заявки на возврат. Получите методом /v2/returns/rfbs/list.
...
Передайте комментарий, если в ответе метода /v2/returns/rfbs/get параметр rejection_reason.is_comment_required — true.
...
Ответы
200Частичная компенсация подтверждена
Response Schema: application/json
object
400Неверный параметр
403Доступ запрещён
...
Получите доступные действия returns.available_actions методом /v2/returns/rfbs/get.
...
Получите возможные причины отмены returns.rejection_reason методом /v2/returns/rfbs/get.
...
Ответы
200Информация о возвратной отгрузке
Response Schema: application/json
articles	
Array of objects
Артикулы товаров.
...
object
Ответы
200Штрихкод для возвратной отгрузки
Response Schema: application/pdf
file_content	
string
PDF-файл со штрихкодом в кодировке Base64.
...
file_content	
string
PNG-файл со штрихкодом в кодировке Base64.
...
Отправить файл в чат с покупателем могут только продавцы с подпиской Premium Plus или Premium Pro. Получите список чатов с покупателем chats.chat.chat_type="Buyer_Seller" в ответе метода /v3/chat/list.
...
Ответы
200Счёт-фактура создана или изменена
Response Schema: application/json
result	
boolean
Результат работы метода.
...
PARTIAL_APPROVED — товары с предупреждениями, требуют доработки;
IMAGE_ABSENT — товары без фото;
ARCHIVED — товары в архиве;
AUTO_ARCHIVED — товары, архивированные автоматически;
MANUAL_ARCHIVED — товары, архивированные вручную.
Ответы
200Отчёт по товарам
Response Schema: application/json
result	
...
EN — английский.
Ответы
200Отчёт о возвратах FBO и FBS
Response Schema: application/json
result	
object
Результаты запроса.
...
ALL — все склады Ozon.
Ответы
200Отчёт по остаткам и товарам
Response Schema: application/json
result	
object
Результат запроса.
...
Ответы
200Информация об оборачиваемости
Response Schema: application/json
items	
Array of objects
Товары.
...
macrolocal_cluster_ids	
Array of strings <int64>
Фильтр по идентификаторам макролокальных кластеров. Получить идентификаторы можно в параметре macrolocal_cluster_ids метода /v1/cluster/list или через метод /v2/cluster/list.
...
Ответы
200Аналитика по остаткам на складах
Response Schema: application/json
items	
Array of objects
Информация о товарах.
...
integer <int32>
Количество товаров, которые доступны к продаже. Соответствует столбцу «Доступно к продаже».
...
macrolocal_cluster_id	
integer <int64>
Идентификатор макролокального кластера. Получите информацию о кластере методом /v1/cluster/list или /v2/cluster/list.
...
turnover_grade	
string
Enum: "UNSPECIFIED" "TURNOVER_GRADE_NONE" "DEFICIT" "POPULAR" "ACTUAL" "SURPLUS" "NO_SALES" "WAS_NO_SALES" "RESTRICTED_NO_SALES" "COLLECTING_DATA" "WAITING_FOR_SUPPLY" "WAS_DEFICIT" "WAS_POPULAR" "WAS_ACTUAL" "WAS_SURPLUS"
...
valid_stock_count	
integer <int32>
Количество товаров, которые готовятся к продаже. Соответствует столбцу «Готовим к продаже».
...
Ответы
200Позаказный отчёт о реализации
Response Schema: application/json
header	
object
Титульный лист отчёта.
...
Ответы
200Отчёт по выкупленным товарам
Response Schema: application/json
products	
Array of objects
...
Свернуть всё
Чеки
Подробнее о чеках в Справке для продавцов Ozon Global.
...
required
string
Идентификатор чека. Получите значение параметра методом /v1/receipts/seller/list.
...
content	
string <byte>
PDF-файл с чеком в бинарном виде.
...
Ответы
200Список чеков продавца
Response Schema: application/json
has_next	
boolean
Признак, что в ответе вернулись не все записи:

true — сделайте повторный запрос с новым параметром page, чтобы получить остальные значения;
false — ответ содержит все записи с чеками.
receipts	
Array of objects
Информация о чеках.
...
required
string
Тип операции. Получите значение параметра методом /v1/receipts/seller/list.

parent_receipt_id	
string
Идентификатор родительского чека. Передайте параметр с идентификатором чека, который нужно изменить.
...
rating_reaction_time — время в секундах, в течение которого покупатели в среднем ждали ответа на своё первое сообщение в чате за последние 30 дней.
rating_average_response_time — время в секундах, в течение которого покупатели в среднем ждали вашего ответа за последние 30 дней.
rating_replied_dialogs_ratio — доля диалогов хотя бы с одним вашим ответом в течение 24 часов за последние 30 дней.
rating_general_indicator_fbs_rfbs — индекс ошибок FBS и rFBS.
rating_price_green — выгодный индекс цен.
...
defects	
Array of objects
Индекс ошибок по дням.

index	
number <double>
Значение индекса ошибок за период.

period_from	
string
Дата начала расчётного периода в формате YYYY-MM-DD.

period_to	
string
Дата окончания расчётного периода в формате YYYY-MM-DD.
...
errors	
Array of objects
Отправления, которые повлияли на индекс.
...
Свернуть всё
Работа с цифровыми товарами
Подробнее о цифровых товарах в Базе знаний
...
Ответы
200Коды цифровых товаров загружены
Response Schema: application/json
exemplars_by_sku	
Array of objects
Данные о кодах цифрового товара по SKU.
...
failed_exemplars	
Array of objects
Список кодов цифровых товаров с ошибками.

received_qty	
integer <int32>
Количество кодов цифрового товара, которые были приняты.

rejected_qty	
integer <int32>
Количество кодов цифровых товаров, которые не были приняты или переданы.
...
status	
string
Статус отправления: awaiting_packaging — ожидает упаковки.

waiting_deadline_for_digital_code	
string <date-time>
Время, до которого нужно передать коды цифровых товаров. Передайте коды цифровых товаров с помощью метода /v1/posting/digital/codes/upload.
...
errors	
Array of objects
Ошибки, которые возникли при обработке запроса.
...
updated	
boolean
true, если запрос выполнен успешно и остатки обновлены.
...
DESC — по убыванию.
Ответы
200Информация о комментариях на отзыв
Response Schema: application/json
comments	
Array of objects
...
Ответы
200Количество отзывов по статусам
Response Schema: application/json
new	
integer <int32>
...
viewed	
integer <int32>
Количество просмотренных отзывов.
...
object
Ответы
200Количество обработанных и необработанных отзывов
Response Schema: application/json
processed	
integer <int32>
Количество обработанных отзывов.
...
Ответы
200Идентификатор ответа на вопрос
Response Schema: application/json
answer_id	
string
...
Ответы
200Количество вопросов по статусам
Response Schema: application/json
all	
integer <int64>
Всего вопросов.
...
has_next	
boolean
true, если в ответе вернулись не все вопросы.
...
last_id	
string
Идентификатор последнего значения на странице. Чтобы получить следующие значения, укажите last_id из ответа предыдущего запроса.
...
Ответы
200Отчёт по вывозу и утилизации с поставки FBO
Response Schema: application/json
last_id	
string
Идентификатор последнего значения на странице.
...
Ответы
200Отчёт по вывозу и утилизации со стока FBO
Response Schema: application/json
last_id	
string
Идентификатор последнего значения на странице.
...
Ответы
200Настройки скидки изменены
Response Schema: application/json
accepted	
boolean
true, если запрос принят. Используйте метод /v1/product/stairway-discount/by-quantity/get, чтобы узнать результат изменения скидки.
...
enabled	
boolean
true, если скидка от количества включена.
...
Статус изменения скидки от количества. Возможные значения:

ERROR — ошибка при изменении скидки. Вызовите метод /v1/product/stairway-discount/by-quantity/set ещё раз.
IN_PROCESS — изменение в процессе.
SUCCESS — изменение скидки применено к товару.
400Неверный параметр
403Доступ запрещён
404Ответ не найден
409Конфликт запроса
...
required
string <date-time>
Дата окончания отчётного периода в формате YYYY-MM-DD. Максимальный период между date_from и date_to — 30 дней.
...
approved_discount	
number <double>
Скидка в рублях, которую одобрил продавец. Передайте значение 0, если продавец не одобрил заявку.
...
auto_moderated_info	
object
Информация об автоматической модерации заявки.
...
integer <uint64>
Время для изменения решения в секундах.
...
end_at_duration	
integer <uint64>
Время окончания действия заявки в секундах.
...
is_auto_moderated	
boolean
true, если модерация была автоматической.
...
reduction_factor	
number <double>
Разница между ценой пользователя и продавца в момент создания заявки.
...
Ответы
200Видимость товара настроена
Response Schema: application/json
items	
Array of objects
Информация о видимости товаров.
...
Чтобы получить список отправлений в любом статусе, используйте метод /v3/posting/fbo/list.
...
Ответы
200Начисления по отправлениям
Response Schema: application/json
posting_accruals	
Array of objects
Список начислений по отправлениям.
...
Ответы
200Информация о видимости товара
Response Schema: application/json
items	
Array of objects
Список товаров.
...
На каких витринах показывается товар:

UNSPECIFIED — не определено;
OZON — только на Ozon;
SELECT — только на Селект;
OZON_SELECT — на Селект и Ozon;
NONE — товар скрыт везде.
sku	
integer <int64>
Идентификатор товара в системе Ozon — SKU.
...
code	
string
Уникальный идентификатор отчёта. Получите отчёт методом /v1/report/info.
...
Ответы
200Информация об эконом-товаре
Response Schema: application/json
items	
Array of objects
Эконом-товары.
...
Описание и примерыКонсоль
Товары в акцию добавляются автоматически, использовать метод /v1/seller-actions/products/add не нужно.
...
action_id	
integer <uint64>
Идентификатор акции. Получите значение параметра методом /v1/seller-actions/list.
...
Описание и примерыКонсоль
Товары в акцию добавляются автоматически, вызывать метод /v1/seller-actions/products/add не нужно.
...
INDIVIDUAL_DISCOUNT_BY_PRODUCTS — бонусы продавца;
OZON_ACCOUNT_DISCOUNT — повышенная скидка с картой Ozon Банка;
...
Ответы
200Файл с промокодами
Response Schema: application/json
file	
string
Ссылка на CSV-файл с промокодами.
...
required
string <date-time>
Дата и время автодобавления товаров в акцию из параметра result.auto_add_dates в ответе метода /v1/actions.
...
Ответы
200Список товаров с автодобавлением
Response Schema: application/json
products	
Array of objects
Список товаров с автодобавлением.
...
Ответы
200Список доступных товаров для автодобавления в акцию
Response Schema: application/json
products	
Array of objects
Список доступных товаров для автодобавления.
...
Ответы
200Товары удалены из автодобавления
Response Schema: application/json
product_ids	
Array of strings <uint64>
Идентификаторы товаров, которые удалены из автодобавления.
...
Ответы
200Товары добавлены или обновлены в автодобавлении
Response Schema: application/json
below_min_price	
Array of objects
Список товаров с ценой ниже минимальной.

extremely_low_price	
Array of objects
Список товаров со скидкой больше 70%.

failed_price	
Array of objects
Список товаров, которые не прошли валидацию по цене.

rejected	
Array of objects
Идентификаторы товаров, которые не получилось добавить или обновить.

updated_ids	
Array of strings <uint64>
Идентификаторы товаров, которые получилось добавить или обновить.
...
required
Array of strings
Items Enum: "TYPE_NEW_MESSAGE" "TYPE_UPDATE_MESSAGE" "TYPE_MESSAGE_READ" "TYPE_CHAT_CLOSED" "TYPE_NEW_POSTING" "TYPE_POSTING_CANCELLED" "TYPE_STATE_CHANGED" "TYPE_DELIVERY_DATE_CHANGED" "TYPE_CUTOFF_DATE_CHANGED" "TYPE_CREATE_ITEM" "TYPE_UPDATE_ITEM" "TYPE_CREATE_OR_UPDATE_ITEM" "TYPE_STOCKS_CHANGED"
Типы уведомлений:
...
errors	
Array of objects
Ошибки, возникшие при проверке.

is_active
required
boolean
true, если URL-адрес активен.
...
true — чтобы включить уведомления;
false — чтобы выключить уведомления.
id
required
integer <int64>
Идентификатор URL-адреса.
...
Ответы
200Уведомления включены или выключены
400Неверный параметр
403Доступ запрещён
404Ответ не найден
409Конфликт запроса
...
Ответы
200Подключённые URL-адреса
Response Schema: application/json
urls
required
Array of objects
Подключённые URL-адреса.

Array ()
created_at
required
string <date-time>
Дата подключения URL-адреса.

enable
required
boolean
true, если URL-адрес включён.
...
seller_endpoint	
object
URL-адрес, на который приходит тип уведомлений.

type
required
string
Enum: "TYPE_NEW_MESSAGE" "TYPE_UPDATE_MESSAGE" "TYPE_MESSAGE_READ" "TYPE_CHAT_CLOSED" "TYPE_NEW_POSTING" "TYPE_POSTING_CANCELLED" "TYPE_STATE_CHANGED" "TYPE_DELIVERY_DATE_CHANGED" "TYPE_CUTOFF_DATE_CHANGED" "TYPE_CREATE_ITEM" "TYPE_UPDATE_ITEM" "TYPE_CREATE_OR_UPDATE_ITEM" "TYPE_STOCKS_CHANGED"
Тип уведомления:
...
supplies	
Array of objects
Информация о грузоместах и транспортных грузоместах.
...
limits	
object
Количество грузомест и товаров в поставке.
...
Request Body schema: application/json
One of cargo_idstransport_cargo_ids
cargo_ids
required
Array of strings <int64> <= 1500
Список идентификаторов грузомест, которые нужно удалить.

supply_id
required
integer <int64>
Идентификатор поставки. Получите значение параметра методом /v3/supply-order/get.

transport_cargo_deletion_type
required
string
Enum: "UNBIND_CONTAINED_CARGOES" "DELETE_CONTAINED_CARGOES"
Тип удаления транспортного грузоместа:

UNBIND_CONTAINED_CARGOES — удалить только транспортное грузоместо и отвязать от него все грузоместа;
DELETE_CONTAINED_CARGOES — удалить транспортное грузоместо вместе с грузоместами.
transport_cargo_ids	
Array of strings <int64> <= 40
Список идентификаторов транспортных грузомест, которые нужно удалить.

Ответы
200Грузоместа и транспортные грузоместа удалены
Response Schema: application/json
errors	
object
Ошибки.
...
operation_id	
string
Идентификатор операции. Получите статус операции методом /v2/cargoes/delete/status.
...
required
string
Идентификатор операции из метода /v2/cargoes/delete.

Ответы
200Статус удаления грузомест и транспортных грузомест
Response Schema: application/json
errors	
object
Ошибки.
...
Подробнее о работе с транспортными грузоместами
...
Ответы
200Транспортные грузоместа включены или отключены
Response Schema: application/json
operation_id	
string
Идентификатор операции. Получите статус операции методом /v1/cargoes/transport/activate/status.
...
required
string
Идентификатор операции из метода /v1/cargoes/transport/activate.
...
error_reasons	
Array of strings
Items Enum: "OPERATION_NOT_FOUND" "SUPPLY_IS_FINALIZED" "CAN_NOT_EDIT_TAG" "UNDEFINED"
Ошибки при включении или отключении транспортных грузомест:

OPERATION_NOT_FOUND — операция не найдена;
SUPPLY_IS_FINALIZED, CAN_NOT_EDIT_TAG — нельзя изменить поставку;
UNDEFINED — неизвестная ошибка.
status	
string
Enum: "SUCCESS" "IN_PROGRESS" "FAILED"
Статус включения или отключения транспортных грузомест:
...
Ответы
200Транспортное грузоместо создано
Response Schema: application/json
error_reasons	
Array of strings
Items Enum: "SUPPLY_NOT_FOUND" "WAREHOUSE_LIMITS_EXCEED" "SUPPLY_DOES_NOT_BELONG_TO_THE_CONTRACTOR" "SUPPLY_DOES_NOT_BELONG_TO_THE_COMPANY" "PALLET_SUPPLY_CONTAINS_BOXES" "SUPPLY_CARGOES_IS_FINALIZED" "SUPPLY_CARGOES_LOCKED" "OPERATION_NOT_FOUND" "ETTN_IS_UPLOADED" "BOX_SUPPLY_CONTAINS_PALLETS" "UNDEFINED"
Ошибки при создании транспортных грузомест:

SUPPLY_NOT_FOUND — поставка не найдена;
WAREHOUSE_LIMITS_EXCEED — превышены лимиты склада;
SUPPLY_DOES_NOT_BELONG_TO_THE_CONTRACTOR — заявка на поставку не принадлежит юридическому лицу;
SUPPLY_DOES_NOT_BELONG_TO_THE_COMPANY — заявка на поставку не принадлежит продавцу;
PALLET_SUPPLY_CONTAINS_BOXES — палетная поставка не может содержать коробки;
SUPPLY_CARGOES_IS_FINALIZED — нельзя редактировать заявку на поставку;
SUPPLY_CARGOES_LOCKED — другой процесс блокирует редактирование грузомест поставки;
OPERATION_NOT_FOUND — операция не найдена;
ETTN_IS_UPLOADED — нельзя редактировать поставку с загруженной эТТН;
BOX_SUPPLY_CONTAINS_PALLETS — поставка может содержать только коробки;
UNDEFINED — неизвестная ошибка.
operation_id	
string
Идентификатор операции. Получите статус операции методом /v1/cargoes/transport/create/status.
...
operation_id	
string
Идентификатор операции из метода /v1/cargoes/transport/create.
...
result	
object
Созданные транспортные грузоместа.

transport_cargoes	
Array of objects
Информация о созданных транспортных грузоместах.

status	
string
Enum: "SUCCESS" "IN_PROGRESS" "FAILED"
Статус создания транспортных грузомест:
...
Request Body schema: application/json
One of cargoes_unbind_transport_cargoestransport_cargo_bind
...
Ответы
200Грузоместа связаны или отвязаны
Response Schema: application/json
error_reasons	
Array of strings
Items Enum: "OPERATION_NOT_FOUND" "OPERATION_FAILED" "SUPPLY_NOT_FOUND" "SUPPLY_DOES_NOT_BELONG_TO_COMPANY" "SUPPLY_DOES_NOT_BELONG_TO_CONTRACTOR" "TRANSPORT_CARGOES_NOT_ENABLED_FOR_SUPPLY" "INVALID_SUPPLY_STATE" "SUPPLY_IS_FINALIZED" "CARGO_IDS_NOT_FOUND" "TRANSPORT_CARGO_IDS_NOT_FOUND" "ETTN_IS_UPLOADED"
Ошибки связывания или отвязывания грузомест:

OPERATION_NOT_FOUND — операция не найдена;
OPERATION_FAILED — операция завершилась с ошибкой;
SUPPLY_NOT_FOUND — поставка не найдена;
SUPPLY_DOES_NOT_BELONG_TO_COMPANY — заявка на поставку не принадлежит продавцу;
SUPPLY_DOES_NOT_BELONG_TO_CONTRACTOR — поставка не принадлежит юридическому лицу;
TRANSPORT_CARGOES_NOT_ENABLED_FOR_SUPPLY — для поставки не включены транспортные грузоместа;
INVALID_SUPPLY_STATE — неверный статус поставки;
SUPPLY_IS_FINALIZED — нельзя редактировать поставку;
CARGO_IDS_NOT_FOUND — грузоместа не найдены;
TRANSPORT_CARGO_IDS_NOT_FOUND — траспортные грузоместа не найдены;
ETTN_IS_UPLOADED — нельзя редактировать поставку с загруженной эТТН.
operation_id	
string
Идентификатор операции. Получите статус операции методом /v1/cargoes/transport/bind/status.
...
required
string
Идентификатор операции из метода /v1/cargoes/transport/bind.
...
string
Enum: "SUCCESS" "IN_PROGRESS" "FAILED"
Статус связывания или отвязывания грузомест:
...
Ответы
200Информация о грузоместах в поставках
Response Schema: application/json
not_found_supply_ids	
Array of strings <int64>
Поставки, которые не удалось найти.

supplies_cargoes	
Array of objects
Информация о грузоместах в поставках.
...
Ответы
200Этикетки сгенерированы
Response Schema: application/json
error_reasons	
Array of strings
Items Enum: "ORDER_NOT_FOUND" "OPERATION_NOT_FOUND" "OPERATION_FAILED" "ALL_SUPPLIES_SKIPPED" "LABELS_COUNT_EXCEED" "UNDEFINED"
Ошибки при генерации этикеток транспортных грузомест:

ORDER_NOT_FOUND — заявка не найдена;
OPERATION_NOT_FOUND — операция не найдена;
OPERATION_FAILED — операция завершилась с ошибкой;
ALL_SUPPLIES_SKIPPED — нет этикеток для поставок;
LABELS_COUNT_EXCEED — превышено количество генерируемых этикеток;
UNDEFINED — неизвестная ошибка.
operation_id	
string
Идентификатор операции. Получите статус операции методом /v1/cargoes/label/transport-by-order/status.
...
required
string
Идентификатор операции из метода /v1/cargoes/label/transport-by-order/create.
...
result	
object
Этикетки транспортных грузомест.
...
Array of strings <int64>
Поставки, по которым не сгенерированы этикетки.
...
transport_cargo_ids	
Array of strings <int64> <= 40 items
Идентификаторы транспортных грузомест. Если ничего не передать, в ответе вернутся этикетки для всех транспортных грузомест в поставке.
...
error_reasons	
Array of strings
Items Enum: "INVALID_STATE" "OPERATION_NOT_FOUND" "OPERATION_FAILED" "SUPPLY_NOT_BELONG_CONTRACTOR" "SUPPLY_NOT_BELONG_COMPANY" "SUPPLY_IS_EMPTY" "CARGOES_NOT_FOUND"
Ошибки при генерации этикеток транспортных грузомест:

INVALID_STATE — недопустимое состояние поставки;
OPERATION_NOT_FOUND — операция не найдена;
OPERATION_FAILED — операция завершилась с ошибкой;
SUPPLY_NOT_BELONG_CONTRACTOR — поставка не принадлежит юридическому лицу;
SUPPLY_NOT_BELONG_COMPANY — заявка на поставку не принадлежит продавцу;
SUPPLY_IS_EMPTY — в поставке нет грузомест;
...
post
/v1/cargoes/label/transport/status
...
operation_id	
string
Идентификатор операции из метода /v1/cargoes/label/transport/create.
...
DRAFT_STATUS_UNSPECIFIED — не определён;
NEW — новый;
SUPPLY_VARIANT_CONFIRMATION — ожидает подтверждения;
SUPPLY_NOT_CONFIRMED — отклонён складом.
supply_id	
string
Идентификатор поставки.
...
RESERVE_FAILURE_TYPE_UNSPECIFIED — не определена;
REQUEST_VALIDATION — в запросе указана дата резервирования в прошлом;
INVALID_RESERVE — исходный резерв не найден, неактивен или уже содержит заявки, а его пытаются перезаписать;
LOGISTICS_REASON — ошибка на стороне логистики;
SCHEDULE_REASON — ошибка на стороне расписаний;
NO_CAPACITY — нет доступных слотов для резервирования.
row_version	
integer <int64>
Идентификатор актуальной версии черновика.
...
Причины отсутствия таймслотов:

EMPTY_TIMESLOTS_REASON_UNSPECIFIED — не определено;
LOGISTICS_UNKNOWN — неизвестная ошибка на стороне логистики;
NO_ROUTE — нет маршрута;
NO_ROUTE_SCHEDULES — нет расписания на маршруте;
NO_LOGISTICS_CAPACITY — недостаточно доступных слотов на маршруте;
SCHEDULE_UNKNOWN — неизвестная ошибка на стороне расписаний;
NOT_ENOUGH_CAPACITY — недостаточно доступных слотов на складе;
NOT_ENOUGH_TRUCKS — недостаточно машиномест;
LIMITS_NOT_AVAILABLE — не настроены лимиты на складе;
CROSS_DOCK_RESERVE_MISSING — не забронирован кросс-докинговый резерв на складе;
SCHEDULE_RESERVE_MISSING — отсутствует необходимый резерв по расписанию.
timeslots	
Array of objects
...
required
string
Идентификатор провалидированного списка товаров. Чтобы получить, используйте метод /v1/fbp/draft/direct/product/validate.
...
bundle_generated	
boolean
true, если провалидированный список товаров создан.
...
Ответы
200Список drop-off пунктов
Response Schema: application/json
drop_off_points	
Array of objects
Список drop-off пунктов.
...
Ответы
200Расписание работы
Response Schema: application/json
calendar	
Array of objects
Расписание работы drop-off пункта.
...
DAY_OF_WEEK_UNSPECIFIED — не определён,
MONDAY — понедельник,
TUESDAY — вторник,
WEDNESDAY — среда,
THURSDAY — четверг,
...
bundle_generated	
boolean
true, если создан товарный состав.
...
bundle_generated	
boolean
true, если проверенный список товаров создан.
...
Ответы
200График работы получен
Response Schema: application/json
calendar	
Array of objects
Информация о графике работы drop-off пункта.
...
CREATE_ACT_ERROR_REASON_UNSPECIFIED — не определена;
INVALID_ORDER_TYPE — нельзя создать акт для указанного идентификатора поставки.
file_uuid	
string
...
is_success	
boolean
true, если в запросе нет ошибок.
...
Ответы
200Статус генерации акта приёмки
Response Schema: application/json
cdn_url	
string
Ссылка на акт приёмки.
...
ERROR_REASON_UNSPECIFIED — не определена;
INVALID_COMPANY — неверная компания;
FILE_NOT_FOUND — файл не найден;
GENERATE_TIMEOUT_REACHED — превышено время генерации;
GENERATION_ERROR — ошибка во время генерации.
status	
string
Default: "STATUS_UNSPECIFIED"
...
STATUS_UNSPECIFIED — не определён;
...
Ответы
200Статус генерации транспортной накладной
Response Schema: application/json
error_message	
string
Описание ошибки.
...
label_url	
string
Ссылка на этикетки для поставки.
...
STATE_TYPE_UNSPECIFIED — не определён;
IN_PROGRESS — в процессе;
FINISHED — завершилась успешно;
FAILED — ошибка.
defaultОшибка
Примеры запроса
Content type
...
Ответы
200Информация о завершённой поставке
Response Schema: application/json
act_file_uuid	
string
Идентификатор акта приёмки.
...
bundle_sku_summary	
object
Сводная информация по товарам в поставке.
...
Статус завершённой поставки:

ARCHIVE_STATUS_UNSPECIFIED — не определён;
COMPLETED — завершена;
REJECTED_AT_SUPPLY_WAREHOUSE — отклонена складом;
...
Ответы
200Список завершённых поставок
Response Schema: application/json
has_next	
boolean
true, если в ответе вернулись не все значения.
...
Статус задания на генерацию этикеток:

UNSPECIFIED — не определён;
IN_PROGRESS — в процессе генерации;
FINISHED — генерация завершилась успешно;
...
ORDER_STATUS_UNSPECIFIED — не определён;
READY_TO_SUPPLY — готов к отгрузке;
FILLING_DELIVERY_DETAILS — заполнение данных поставки;
COURIER_ASSIGNED — курьер назначен;
COURIER_PICKED_UP — курьер забрал поставку;
ACCEPTANCE_AT_DROP_OFF_POINT — принято на drop-off пункте;
IN_TRANSIT_TO_STORAGE_WAREHOUSE — в пути на склад размещения;
ACCEPTANCE_AT_STORAGE_WAREHOUSE — приёмка на складе;
...
Чтобы получить следующие значения, укажите id последней поставки из ответа предыдущего запроса.
...
has_next	
boolean
true, если в ответе вернули не все поставки.
...
last_id	
integer <int64>
Идентификатор последней поставки на странице.
...
sort_by	
string
Параметр, по которому сортируются отправления:

last_change_status_date — по дате последнего изменения статуса;
in_process_at — по дате начала обработки.
sort_dir	
string
Enum: "ASC" "DESC"
Направление сортировки:
...
Ответы
200Состав подтверждён
Response Schema: application/json
error_containers	
Array of objects
Ошибки по грузоместам.
...
available_actions	
Array of strings
Действия с грузоместом:

approve — подтвердить состав;
get_label_container — получить этикетку;
delete — удалить;
place_box_into_pallet — добавить коробку на палету;
remove_box_from_pallet — убрать коробку с палеты;
place_posting_into_container — перенести отправление в другое грузоместо;
remove_posting_from_container — убрать отправление из грузоместа;
get_documents — получить транспортную накладную.
cargo_type	
string
Тип грузоместа.
...
count_of_postings	
integer <int32>
Количество отправлений в грузоместе.

created_at	
string <date-time>
Дата создания грузоместа в UTC.

parent_container_id	
integer <int64>
Идентификатор родительского грузоместа.
...
Array of strings <int64>
Идентификаторы дочерних грузомест.
...
weight	
number <float>
Суммарный вес отправлений в грузоместе, кг.
...
task_id	
integer <int64>
Идентификатор задачи. Получите его в ответе метода /v1/carriage/container/fill или /v1/carriage/container/approve.
...
Ответы
200Список документов
Response Schema: application/json
content_type	
string
Тип файла: application или pdf.
...
content	
object
Информация о сформированной этикетке.

error_containers	
Array of objects
Ошибки грузомест, по которым не удалось сформировать этикетку.
...
Аналитику по запросам можно проверить за определённые даты. Для этого укажите интервал в полях date_from и date_to. Данные за последний месяц доступны в любом интервале, кроме текущей даты — расчёт происходит в течение 1–2 дней. Аналитика за даты раньше месяца назад доступна только с подпиской Premium, Premium Plus или Premium Pro и только по неделям — в запросе укажите параметр date_from.

Подробнее о работе с запросами товара в Базе знаний продавца
...
Ответы
200Информация о запросах моих товаров
Response Schema: application/json
analytics_period	
object
...
ASCENDING — по возрастанию.
Ответы
200Информация о запросах по конкретному товару
Response Schema: application/json
analytics_period	
object
Период, за который формируется аналитика.
...
Параметр, по которому сортируются поисковые запросы:

CLIENT_COUNT — популярность запроса;
ADD_TO_CART — добавления в корзину;
CONVERSION_TO_CART — конверсия в корзине;
...
Ответы
200Список поисковых запросов
Response Schema: application/json
offset	
string <int64>
Количество поисковых запросов на странице.
...
Ответы
200Список популярных поисковых запросов
Response Schema: application/json
offset	
string <int64>
Количество поисковых запросов на странице.
...
price	
object
Цена товара с учётом акции или продвижения.
...
string
Default: "UNSPECIFIED"
Enum: "UNSPECIFIED" "UNKNOWN" "OUT_OF_STOCK" "BANNED_FOR_AREA" "BANNED_FOR_LEGAL" "BANNED" "BANNED_FOR_NOT_PREMIUM" "DELIVERY_UNAVAILABLE" "BANNED_FOR_INDIVIDUAL" "INVALID_WEIGHT" "INVALID_MULTIPLICITY" "NOT_FOUND_POINTS_DARK_STORES" "INVALID_MULTI_WAREHOUSES" "MIN_PRICE" "OZONE_DELIVERY_UNAVAILABLE" "RFBS_DELIVERY_UNAVAILABLE" "HACK_COURIER_TAGS" "NO_SLA" "DELIVERY_VARIANT_IS_CLOSING" "TPL_NOT_INTEGRATED" "NOT_ALL_WAREHOUSES_ARE_SERVED" "DELIVERY_SLOTS_NOT_FOUND" "NO_ROUTE" "CAPACITY_LIMIT" "PACKAGE_MAX_VOLUME_WEIGHT_RESTRICTION" "PACKAGE_MAX_WEIGHT_RESTRICTION" "MAX_COST_RESTRICTION" "MIN_PACKAGE_WEIGHT_RESTRICTION" "MIN_COST_RESTRICTION" "MAX_DIMENSIONS_RESTRICTION" "PRODUCT_TYPES_RESTRICTION" "PRODUCT_TAGS_RESTRICTION" "SELECTED_DELIVERY_METHOD_UNAVAILABLE" "SELECTED_DELIVERY_TIMESLOT_UNAVAILABLE" "MARKETPLACE_UNAVAILABLE" "INVALID_PVZ_FOR_KGT" "LEGAL_USER_PREMIUM_SPLIT" "USER_ALREADY_HAS_PREMIUM" "WAIT_FOR_PAY_SUBSCRIPTION" "ADDRESS_NOT_SET" "PICKUP_POINT_DISABLED" "LEGAL_PREORDER" "DELIVERY_TYPE_FOR_PREORDER" "CROSS_BORDER_PICKUP" "ORDER_CUSTOMS_TYPES" "PACKAGE_MAX_COST" "SUPER_ECONOM" "ECONOM_NOT_FULL_QUANT" "EMPTY_DELIVERY_METHODS"
Причина недоступности:

UNSPECIFIED — доставка доступна;
UNKNOWN — неизвестная причина;
OUT_OF_STOCK — товар закончился;
BANNED_FOR_AREA — товар заблокирован для этой области;
BANNED_FOR_LEGAL — товар заблокирован для юридических лиц;
BANNED — товар заблокирован;
BANNED_FOR_NOT_PREMIUM — товар заблокирован для покупателей без подписки Premium;
DELIVERY_UNAVAILABLE — доставка недоступна, например, курьеры перегружены;
BANNED_FOR_INDIVIDUAL — товар заблокирован для физических лиц;
INVALID_WEIGHT — вес товара не указан;
INVALID_MULTIPLICITY — недопустимая кратность в штуках;
NOT_FOUND_POINTS_DARK_STORES — пункты в массиве дарксторов не найдены;
INVALID_MULTI_WAREHOUSES — товары в заказе с разными схемами доставки неверно распределены;
MIN_PRICE — сплит не прошёл минимальную цену;
OZONE_DELIVERY_UNAVAILABLE — доставка Ozon недоступна;
RFBS_DELIVERY_UNAVAILABLE — доставка по системе rFBS недоступна;
HACK_COURIER_TAGS — способ доставки исключён по правилу приоритетного показа;
NO_SLA — норматив комплектации отсутствует;
DELIVERY_VARIANT_IS_CLOSING — способ доставки в неподходящем статусе;
TPL_NOT_INTEGRATED — точки, по которым возврат невозможен;
NOT_ALL_WAREHOUSES_ARE_SERVED — доставка со склада отправления отсутствует;
DELIVERY_SLOTS_NOT_FOUND — таймслоты отсутствуют;
NO_ROUTE — маршрут не найден;
CAPACITY_LIMIT — таймслоты отсеяны из-за заполненности капаситета;
PACKAGE_MAX_VOLUME_WEIGHT_RESTRICTION — ограничение на максимальный объёмный вес посылки;
PACKAGE_MAX_WEIGHT_RESTRICTION — ограничение на максимальный физический вес посылки, в килограммах до тысячных грамма;
MAX_COST_RESTRICTION — ограничение на максимальную стоимость заказа, учитывается стоимость товаров, их доставки, но не учитывается страховой сбор в рублях;
MIN_PACKAGE_WEIGHT_RESTRICTION — ограничение на минимальный физический вес посылки в килограммах до тысячных грамма;
MIN_COST_RESTRICTION — ограничение на минимальную стоимость товаров заказа в рублях;
MAX_DIMENSIONS_RESTRICTION — ограничение на максимальные габариты посылки в сантиметрах;
PRODUCT_TYPES_RESTRICTION — ограничение на допустимые в заказе товарные категории;
PRODUCT_TAGS_RESTRICTION — ограничение на допустимые в заказе теги товаров;
...
MARKETPLACE_UNAVAILABLE — в заказе товары нескольких маркетплейсов, оформить заказ можно только с 1;
INVALID_PVZ_FOR_KGT — выбранный ПВЗ не подходит для КГТ;
LEGAL_USER_PREMIUM_SPLIT — юридическим лицам запрещена покупка подписки Premium;
USER_ALREADY_HAS_PREMIUM — у пользователя уже есть подписка Premium и она не подарочная;
WAIT_FOR_PAY_SUBSCRIPTION — пользователь купил премиум-подписку, но не оплатил заказ или подписка ещё не перешла в активный статус;
ADDRESS_NOT_SET — адрес не установлен;
PICKUP_POINT_DISABLED — ПВЗ недоступен;
LEGAL_PREORDER — предзаказ недоступен юридическим лицам;
DELIVERY_TYPE_FOR_PREORDER — тип доставки недоступен для предзаказа;
CROSS_BORDER_PICKUP — CrossBorder-товары не доставляются в пункты выдачи;
ORDER_CUSTOMS_TYPES — ограничения на таможенные типы;
PACKAGE_MAX_COST — ограничение на максимальную стоимость посылки,учитывается стоимость товаров и их доставки;
...
is_same_building	
boolean
true, если все точки находятся в одном здании.
...
viewport	
object
Область карты для получения точек в кластере.
...
Ответы
200Информация о точке самовывоза
Response Schema: application/json
points	
Array of objects
Информация о пунктах самовывоза.
...
enabled	
boolean
true, если пункт самовывоза доступен.
...
cancellable	
boolean
true, если заказ можно отменить.
...
postings	
Array of objects
Информация о возможности отмены отправлений.
...
Значение параметра delivery_schema должно совпадать с тем, что вы передали в /v2/delivery/checkout.
...
delivery
required
courier (object) or pick_up (object)
Информация о доставке.
...
Ответы
200Сообщение со статусом отмены
Response Schema: application/json
message	
string
Текст сообщения.
...
Ответы
200Список экземпляров отправления с маркировками
Response Schema: application/json
invalid_postings	
Array of strings
Список неверных идентификаторов отправлений.

issued_exemplars	
Array of objects
Список выданных покупателям экземпляров товаров.

non_issued_exemplars	
Array of objects
Список не выданных покупателям экземпляров товаров.
...
method is not allowed	Метод не существует. Проверьте тип запроса и повторите попытку. Для методов Ozon Доставки используйте OAuth-токен, а не Api-key.
/v1/delivery/point/list
Ошибка	Описание
token must be issued for seller, not oauth-client	Неверный тип токена. Используйте OAuth-токен, а не Api-key.
method is not allowed: OZON logistic is disabled	Метод не существует. Убедитесь, что у вас подключена Ozon Доставка.
Подробнее о сервисе Ozon Доставка в Базе знаний продавца
/v5/fbs/posting/product/exemplar/validate
Ошибка	Описание
...
Подробнее о продаже опасных товаров в Базе знаний продавца
...
/v4/posting/fbs/ship
Ошибка	Описание
TRANSITION_IS_NOT_POSSIBLE	Вы передали некорректный порядок статусов заказов rFBS. Получите текущий статус отправления методом /v3/posting/fbs/get. Изменение статуса происходит асинхронно.
...
INCORRECT_OVH_FOR_POSTING	Объёмно-весовые характеристики отправления превышают ограничения пункта приёма. Получите информацию об ограничениях по номеру отправления методом /v1/posting/fbs/restrictions.
/v2/posting/fbs/package-label
Ошибка	Описание
...
missing_dimension	Не указаны размер и вес товара. Заполните параметры items.height, items.width, items.depth и items.weight.
Подробнее об объёмно-весовых характеристиках в Базе знаний продавца
VALUE_MAX_LIMIT	Вы превысили лимит на размер товара.
Подробнее об объёмно-весовых характеристиках в Базе знаний продавца
EMPTY_REQUIRED	Вы не заполнили обязательное поле.
description_category_invalid	Категория не найдена или не указана. Проверьте категорию методом /v1/description-category/tree.
description_category_has_no_description_type	Тип товара не относится к указанной категории. Получите список категорий и типов методом /v1/description-category/tree. Используйте значение последнего уровня выбранной категории.
Подробнее о категориях и типах товаров в Базе знаний продавца
description_category_is_legacy и levels_category_not_found	Категория устарела. Получите список актуальных категорий методом /v1/description-category/tree.
Подробнее о категориях товаров в Базе знаний продавца
description_category_is_empty	Не указана категория — items.description_category_id.
description_type_is_empty	Не указан тип товара — items.type_id.
Подробнее о типах товаров в Базе знаний продавца
vat_invalid	Неверно указан НДС.
name_too_long	Название товара слишком длинное. Максимальное значение — 255 символов.
Подробнее о названии товара в Базе знаний продавца
all_image_failed	Не удалось скачать фото по ссылке. Проверьте, что ссылка указана без ошибок, доступ к ней открыт и не требует авторизации.
Подробнее о требованиях к фото товаров
invalid_rich_content_json	Rich-контент в формате JSON не соответствует шаблону. Проверьте код в песочнице.
Подробнее о Rich-контенте
all_image_unprocessed	Не удалось загрузить фото. Проверьте, что ссылка указана без ошибок, доступ к ней открыт и не требует авторизации.
Подробнее о требованиях к фото товаров
price_out_of_range	Нельзя установить цену ниже минимального или выше максимального порога в категории товара. Установите среднерыночную цену.

Если вам нужно установить цену выше или ниже порога по категории, напишите в поддержку: Товары и цены → Управление ценами → Ошибки при установке цен.
old_price_less_than_price	Цена до скидки должна быть выше текущей цены. Обновите значение параметра items.old_price методом /v1/product/import/prices.
min_auto_price_too_big	Значение цены после автоприменения скидок и акций должно быть меньше вашей цены. Обновите значение параметра min_price методом /v1/product/import/prices.
min_auto_price_too_small	Минимальная цена должна быть не меньше 50% от вашей цены. Обновите значение параметра min_price методом /v1/product/import/prices.
price_less_than_min_auto_price	Ваша цена должна быть выше минимальной. Обновите значения параметров price и min_price методом /v1/product/import/prices.
/v2/review/list
Ошибка	Описание
not available with existing subscription	Метод недоступен. Подключите подписку, которая указана в описании метода.
...
/v6/fbs/posting/product/exemplar/set и /v5/fbs/posting/product/exemplar/status
Ошибка	Описание
GTD_IS_REQUIRED_ONLY_FOR_LEGAL_CUSTOMER	Грузовую таможенную декларацию должны передавать только юридическим лицам.
EXEMPLAR_ID does not belong to product PRODUCT_ID	Идентификатор экземпляра exemplar_id не соответствует идентификатору товара product_id. Получите корректный exemplar_id методом /v6/fbs/posting/product/exemplar/create-or-get.
...
total limit exceeded	Вы превысили лимит на ассортимент в личном кабинете. Отредактируйте активные карточки или перенесите часть из них в архив. Лимит на ассортимент можно узнать через метод /v4/product/info/limit.
v1/carriage/create
Ошибка	Описание
POSTING_NOT_FOUND	Нет новых отправлений для добавления в отгрузку. Подтвердите предыдущую отгрузку методом v1/carriage/approve или добавьте новые отправления в существующую отгрузку методом /v1/carriage/set-postings.
/v1/warehouse/erfbs/update
Ошибка	Описание
...
В личном кабинете продавца перейдите в раздел Настройки → Уведомления.
На вкладке Push уведомления включите получение уведомлений.
Нажмите Подключить.
Введите URL-адрес сервиса, на который будут отправляться уведомления. Например, https://www.example.com/api/method.
Нажмите Проверить. Ozon отправит запрос для проверки соединения, на который должен ответить ваш сервис. Если соединение установлено, появится сообщение «Данный url доступен для подключения».
Нажмите Сохранить.
В блоке Настройки подключения в выпадающем списке Типы уведомлений выберите нужные.
...
В личном кабинете продавца перейдите в раздел Настройки → Интеграции.
На вкладке Push уведомления нажмите Редактировать.
Введите URL-адрес сервиса, на который будут отправляться уведомления.
Нажмите Проверить. Ozon отправит запрос для проверки соединения, на который должен ответить ваш сервис. Если соединение установлено, появится сообщение «Данный url доступен для подключения».
Нажмите Сохранить.
...
Уведомление о новом заказе может приходить с задержкой. Чтобы иметь актуальную информацию, периодически получайте список необработанных отправлений через метод POST /v3/posting/fbs/unfulfilled/list.
...
TYPE_MESSAGE_READ	Ваше сообщение прочитано покупателем или поддержкой
TYPE_CHAT_CLOSED	Чат закрыт
TYPE_DESCRIPTION_CATEGORY_TREE_CHANGED	Изменение дерева категорий
Новое отправление
При поздней оплате заказа поле in_process_at может быть пустым. Вы можете проверить дату отгрузки через метод POST /v3/posting/fbs/get в поле result.in_process_at.
...
Уведомление работает в тестовом режиме. Рекомендуем проверять дату отгрузки через метод POST /v3/posting/fbs/get в поле result.shipment_date.
...
28 июля 2026
Метод	Изменение
/v1/report/info	Добавили параметр result.additional_data в ответ метода.
/v1/report/list	Добавили параметр result.reports.additional_data в ответ метода.
/v1/finance/realization/posting	Обновили описание параметра message в теле ошибки 400 метода.
/v1/report/realization/posting/create	Добавили бета-метод для получения позаказного отчёта о реализации товаров.
22 июля 2026
Метод	Изменение
/v3/posting/fbs/list	Добавили параметр filter.integration_type_flow в запрос метода.
Добавили параметры result.postings.integration_type_flow и result.postings.sorting_center в ответ метода.
/v4/posting/fbs/list	Добавили параметр filter.integration_type_flow в запрос метода.
Добавили параметры postings.integration_type_flow и postings.sorting_center в ответ метода.
/v3/posting/fbs/get	Добавили параметры result.integration_type_flow и result.sorting_center в ответ метода.
/v3/posting/fbs/unfulfilled/list	Добавили параметры result.postings.integration_type_flow и result.postings.sorting_center в ответ метода.
/v4/posting/fbs/unfulfilled/list	Добавили параметры postings.integration_type_flow и postings.sorting_center в ответ метода.
/v1/analytics/stocks	С 17 августа 2026 года метод возвращает информацию об остатках в реальном времени.
21 июля 2026
Метод	Изменение
/v1/finance/accrual/by-day	Обновили описание параметра accruals.posting.products.delivery.services в ответе метода.
—	В разделе Частые ошибки добавили описание ошибки PRODUCT_IS_ARCHIVED для метода /v2/products/stocks.
16 июля 2026
Метод	Изменение
/v1/product/unarchive	Обновили описание метода.
Обновили тело ошибки метода.
14 июля 2026
Метод	Изменение
/v3/finance/transaction/list
/v3/finance/transaction/totals	Методы устаревают и будут отключены 8 сентября 2026 года. Переключитесь на /v1/finance/accrual/postings, /v1/finance/accrual/types, /v1/finance/accrual/by-day.
10 июля 2026
Метод	Изменение
/v3/product/import	Удалили параметр items.images360 из запроса метода.
Пометили обязательным параметр items.offer_id в запросе метода.
Обновили описание метода.
/v1/product/pictures/import	Удалили параметр images360 из запроса метода.
Удалили параметр result.pictures.is_360 из ответа метода.
Обновили описание метода.
/v2/product/pictures/info	Удалили параметр items.photo_360 из ответа метода.
/v3/product/info/list	Удалили параметр items.images360 из ответа метода.
/v1/product/attributes/update
/v1/product/unarchive
/v1/product/update/offer-id
/v1/product/import-by-sku
/v4/product/info/limit	Обновили описание методов.
/v2/posting/fbo/list	Метод устаревает и будет отключён 31 августа 2026 года. Переключитесь на /v3/posting/fbo/list.
/v3/posting/fbs/unfulfilled/list	Метод устаревает и будет отключён 31 августа 2026 года. Переключитесь на /v4/posting/fbs/unfulfilled/list.
/v3/posting/fbs/list	Метод устаревает и будет отключён 31 августа 2026 года. Переключитесь на /v4/posting/fbs/list.
/v1/posting/digital/list	Метод устаревает и будет отключён 31 августа 2026 года. Переключитесь на /v2/posting/digital/list.
9 июля 2026
Метод	Изменение
/v3/product/list	Добавили параметр filter.skus в запрос метода.
Добавили параметр result.items.sku в ответ метода.
/v1/order/cancel/status
/v1/posting/cancel/status	Обновили описание параметра state в ответе методов.
/v2/delivery/checkout	Обновили тело ошибки метода.
—	В разделе Порядок работы с методами → Управляйте заказами FBO, FBS и rFBS → Схема FBO добавили информацию о распределении товаров по транспортным грузоместам FBO.
8 июля 2026
Метод	Изменение
/v2/supply-order/timeslot/list
/v1/review/comment/create
...
/v1/question/info
/v1/question/list
/v1/question/top-sku	Перенесли методы из бета-раздела в основной.
7 июля 2026
Метод	Изменение
/v2/posting/fbo/get
/v3/posting/fbs/get	Добавили параметр result.external_order в ответ методов.
/v2/posting/fbs/act/create	Метод устаревает и будет отключён 7 сентября 2026. Переключитесь на /v1/carriage/create и /v1/carriage/approve.
2 июля 2026
Метод	Изменение
/v1/product/info/stocks-by-warehouse/fbo	Добавили новый метод для для получения информации о стоках на складах FBO.
1 июля 2026
Метод	Изменение
/v1/posting/fbp/get	Добавили бета-метод для получения информации об отправлении FBP по идентификатору.
30 июня 2026
Метод	Изменение
/v3/chat/list	Обновили описание параметра chats.chat.chat_type в ответе метода.
/v1/warehouse/erfbs/aggregator/create	Добавили параметр delivery_method.is_courier_phone_same_as_warehouse в запрос метода.
/v1/warehouse/erfbs/aggregator/delivery-method/update	Добавили параметр is_courier_phone_same_as_warehouse в запрос метода.
/v1/posting/fbp/list	Добавили параметры postings.financial_data.products.posting_commission и postings.financial_data.products.return_commission в ответ метода.
25 июня 2026
Метод	Изменение
/v1/product/certificate/products/list	Обновили описание параметра page_size в запросе метода.
—	Обновляем корневой TLS/SSL-сертификат GlobalSign — вместо него будем использовать HARICA.
Подробнее о переходе на HARICA на платформе разработчиков Ozon for dev
22 июня 2026
Метод	Изменение
/v1/product/visibility/set	Обновили описание метода.
Обновили описание параметра item_placement.placement в запросе метода.
19 июня 2026
Метод	Изменение
/v1/supply-order/timeslot/get	Метод устаревает и будет отключён 19 августа 2026 года. Переключитесь на /v2/supply-order/timeslot/list.
/v1/supply-order/timeslot/update
/v1/supply-order/timeslot/status	Обновили описание параметра errors в ответе методов.
/v2/supply-order/timeslot/list	Добавили новую версию метода для получения списка доступных интервалов поставки.
—	Добавили раздел Пуш-уведомления → Уведомления, которые отправляет Ozon → Изменение дерева категорий.
Добавили тип уведомления TYPE_DESCRIPTION_CATEGORY_TREE_CHANGED в раздел Пуш-уведомления → Уведомления, которые отправляет Ozon.
18 июня 2026
Метод	Изменение
/v1/draft/create	Метод устарел, удалили его из документации. Используйте /v1/draft/crossdock/create, /v1/draft/direct/create или /v1/draft/multi-cluster/create.
/v1/draft/create/info	Метод устарел, удалили его из документации. Используйте /v2/draft/create/info.
/v1/draft/timeslot/info	Метод устарел, удалили его из документации. Используйте /v2/draft/timeslot/info.
/v1/draft/supply/create	Метод устарел, удалили его из документации. Используйте /v2/draft/supply/create.
/v1/draft/supply/create/status	Метод устарел, удалили его из документации. Используйте /v2/draft/supply/create/status.
11 июня 2026
Метод	Изменение
/v2/cargoes/get
/v2/cargoes/delete
...
/v1/cargoes/label/transport-by-order/status
/v1/cargoes/label/transport/create
/v1/cargoes/label/transport/status	Добавили бета-методы для работы с транспортными грузоместами FBO.
—	В разделе Частые ошибки добавили описание ошибок:
method is not allowed — для всех методов;
token must be issued for seller, not oauth-client и method is not allowed: OZON logistic is disabled — для метода /v1/delivery/point/list;
not available with existing subscription — для метода /v2/review/list.
9 июня 2026
Метод	Изменение
/v4/product/info/limit	Добавили параметр operation_limits в ответ метода.
/v2/chat/list	Метод устарел, удалили его из документации. Используйте /v3/chat/list.
/v1/product/placement-zone/info	Перенесли метод из раздела Загрузка и обновление товаров в раздел Атрибуты и характеристики Ozon.
/v1/finance/accrual/by-day	Изменили название параметра accruals.type_id на accruals.accrual_id в ответе метода.
4 июня 2026
Метод	Изменение
/v1/warehouse/erfbs/aggregator/create	Добавили параметры delivery_method.delivery_costs.min_weight, delivery_method.delivery_costs.max_weight, delivery_method.delivery_costs.min_order_price, delivery_method.delivery_costs.max_order_price и delivery_method.delivery_costs.seller_payment в запрос метода.
Удалили параметры delivery_method.delivery_costs.max_amount, delivery_method.delivery_costs.min_amount и delivery_method.delivery_costs.percent.
/v1/warehouse/erfbs/aggregator/delivery-method/update	Добавили параметры delivery_costs.min_weight, delivery_costs.max_weight, delivery_costs.min_order_price, delivery_costs.max_order_price и delivery_costs.seller_payment в запрос метода.
Удалили параметры delivery_costs.max_amount, delivery_costs.min_amount и delivery_costs.percent.
3 июня 2026
Метод	Изменение
/v2/posting/fbs/act/get-postings	Обновили описание параметра id в запросе метода.
2 июня 2026
Метод	Изменение
/v1/seller/info	Обновили описание параметра company.currency в ответе метода.
/v1/polygon/create	Обновили описание метода.
1 июня 2026
Метод	Изменение
/v2/draft/supply/create	Добавили описание метода.
/v1/draft/crossdock/create
/v1/draft/direct/create
/v1/draft/multi-cluster/create	Обновили описание методов.
/v2/cluster/list	Перенесли метод из бета-раздела в основной.
—	В разделе Порядок работы с методами → Управляйте заказами FBO, FBS и rFBS → Схема FBO → Создать заявку на поставку обновили информацию о создании заявки на поставку по схеме FBO.
28 мая 2026
Метод	Изменение
/v5/product/info/prices	Обновили описание параметров items.marketing_actions, items.marketing_actions.actions, items.marketing_actions.actions.date_from, items.marketing_actions.actions.date_to, items.marketing_actions.actions.title и items.marketing_actions.actions.value в ответе метода.
/v1/fbp/draft/get
/v1/fbp/archive/get
/v1/fbp/order/get	Обновили описание параметров delivery_details.direct_details.timeslot_details.timeslot.timeslot_end, delivery_details.direct_details.timeslot_details.timeslot.timeslot_start, delivery_details.drop_off_point.timeslot.timeslot_end и delivery_details.drop_off_point.timeslot.timeslot_start в ответе методов.
/v1/fbp/draft/list
/v1/fbp/archive/list
/v1/fbp/order/list	Обновили описание параметров items.delivery_details.direct_details.timeslot_details.timeslot.timeslot_end, items.delivery_details.direct_details.timeslot_details.timeslot.timeslot_start, items.delivery_details.drop_off_point.timeslot.timeslot_end и items.delivery_details.drop_off_point.timeslot.timeslot_start в ответе методов.
26 мая 2026
Метод	Изменение
/v3/supply-order/get	Обновили описание параметров orders.supplies.storage_warehouse и orders.supplies.storage_warehouse.warehouse_id в ответе метода.
/v1/supply-order/details	Обновили описание параметров supplies.storage_warehouse и supplies.storage_warehouse.warehouse_id в ответе метода.
/v1/carriage/act-discrepancy/pdf
/v1/warehouse/ozon/list
/v1/warehouse/rfbs/pause
/v1/warehouse/rfbs/unpause	Перенесли методы из бета-раздела в основной.
/v1/return/giveout/get-pdf
/v1/return/giveout/get-png	Обновили описание параметра file_content в ответе методов.
—	В разделе Частые ошибки обновили описание ошибки FLAMMABLE_ONLY_ON_SELF_OR_PROVIDER_DELIVERY для метода /v2/products/stocks.
22 мая 2026
Метод	Изменение
/v1/product/visibility/set	Обновили описание параметров item_placement в запросе метода и items.seller_item_placement в ответе метода.
/v1/supply-order/content/update
/v1/supply-order/content/update/status	Обновили описание параметра errors в ответе методов.
/v2/delivery-method/list	Добавили параметр delivery_methods.tpl_dropoff_point в ответ метода.
/v1/cargoes/create/info	Метод устарел, удалили его из документации. Используйте /v2/cargoes/create/info.
—	В разделе Частые ошибки добавили описание ошибок SELLER_NO_CONTRACT_FAILED, error_attribute_values_empty, error_attribute_values_out_of_range, missing_dimension, VALUE_MAX_LIMIT, EMPTY_REQUIRED, description_category_invalid, description_category_has_no_description_type, description_category_is_legacy, levels_category_not_found, description_category_is_empty, description_type_is_empty, vat_invalid, name_too_long, all_image_failed, invalid_rich_content_json, all_image_unprocessed, price_out_of_range, old_price_less_than_price, min_auto_price_too_big, min_auto_price_too_small и price_less_than_min_auto_price для метода /v3/product/import.
21 мая 2026
Метод	Изменение
/v2/finance/realization	Обновили описание метода.
/v1/warehouse/erfbs/aggregator/create
/v1/warehouse/erfbs/non-integrated/create
/v1/warehouse/erfbs/update	Добавили параметр is_auto_assembly в запрос методов.
—	В разделе Частые ошибки добавили описание ошибок IsAutoAssembly property is not available for c&c delivery method для метода /v1/warehouse/erfbs/update и label not allowed for delivered postings для метода /v2/posting/fbs/package-label.
20 мая 2026
Метод	Изменение
/v1/seller-actions/products/delete	Обновили описание параметра skus в запросе метода.
/v1/finance/balance	Обновили пример запроса.
19 мая 2026
Метод	Изменение
/v1/analytics/data	Обновили описание параметра dimension в запросе метода.
/v2/invoice/create-or-update
/v2/order/create	Обновили описание методов.
/v1/analytics/average-delivery-time/details
/v1/analytics/average-delivery-time
/v1/analytics/average-delivery-time/summary	Методы устарели, удалили их из документации.
15 мая 2026
Метод	Изменение
/v1/barcode/add	Обновили описание метода.
14 мая 2026
Метод	Изменение
/v3/product/info/list	Обновили описание параметра items.promotions.type в ответе метода.
/v3/product/import	Обновили описание параметра items.promotions.type в запросе метода.
/v1/product/placement-zone/info	Добавили описание метода.
/v1/supply-order/content/update	Обновили описание параметра order_id в запросе метода.
/v1/finance/cash-flow-statement/list	Обновили описание метода.
12 мая 2026
Метод	Изменение
/v1/actions	Добавили параметр result.auto_add_dates в ответ метода.
/v1/actions/auto-add/products/list
/v1/actions/auto-add/products/candidates
/v1/actions/auto-add/products/delete
/v1/actions/auto-add/products/update	Добавили бета-методы для работы с автодобавлением товаров в акции.
/v1/product/visibility/info	Добавили бета-метод для получения информации о видимости товаров.
/v5/product/info/prices	Добавили описание метода.
/v1/product/import/prices	Обновили описание параметра prices.min_price в запросе метода.
/v1/product/action/timer/status	Обновили описание параметра statuses.expired_at в ответе метода.
6 мая 2026
Метод	Изменение
/v1/finance/accrual/postings	Добавили бета-метод для получения начислений по отправлениям.
/v1/finance/accrual/types	Добавили бета-метод для получения справочника начислений по отправлениям.
/v1/finance/accrual/by-day	Добавили бета-метод для получения начислений по отправлению за день.
/v3/finance/transaction/list	Метод устаревает и будет отключён 6 июля 2026 года. Переключитесь на /v1/finance/accrual/postings, /v1/finance/accrual/types, /v1/finance/accrual/by-day.
/v3/finance/transaction/totals	Метод устаревает и будет отключён 6 июля 2026 года. Переключитесь на /v1/finance/accrual/postings, /v1/finance/accrual/types, /v1/finance/accrual/by-day.
5 мая 2026
Метод	Изменение
/v3/product/list
/v4/product/info/stocks
/v5/product/info/prices	Обновили описание параметра filter.visibility в запросе методов.
/v1/carriage/container/create
/v1/carriage/container/fill
/v1/carriage/container/approve
/v1/carriage/container/place-into
...
/v1/carriage/container/task/info
/v1/carriage/container/document/get
/v1/carriage/container/label/get	Добавили бета-методы для работы с грузоместами FBS.
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Добавили параметры result.postings.container и result.postings.container_sort_type в ответ методов.
/v4/posting/fbs/list
/v4/posting/fbs/unfulfilled/list	Добавили параметры postings.container и postings.container_sort_type в ответ методов.
/v3/posting/fbs/get	Добавили параметры result.container и result.container_sort_type в ответ метода.
/v1/brand/company-certification/list
/v3/product/import
/v1/product/pictures/import
/v1/product/archive
/v1/product/unarchive
/v1/product/info/wrong-volume	Обновили описание методов.
30 апреля 2026
Метод	Изменение
/v3/posting/fbo/list	Добавили новую версию метода для получения списка отправлений FBO.
/v2/posting/fbo/list	Метод устаревает и будет отключён 1 июня 2026 года. Переключитесь на /v3/posting/fbo/list.
/v4/posting/fbs/unfulfilled/list	Добавили новую версию метода для получения списка необработанных отправлений FBS.
/v3/posting/fbs/unfulfilled/list	Метод устаревает и будет отключён 1 июня 2026 года. Переключитесь на /v4/posting/fbs/unfulfilled/list.
/v4/posting/fbs/list	Добавили новую версию метода для получения списка отправлений FBS.
/v3/posting/fbs/list	Метод устаревает и будет отключён 1 июня 2026 года. Переключитесь на /v4/posting/fbs/list.
/v2/posting/digital/list	Добавили новую версию метода для получения списка отправлений, по которым нужно загрузить коды цифровых товаров.
/v1/posting/digital/list	Метод устаревает. Переключитесь на /v2/posting/digital/list.
/v1/posting/fbp/list	Добавили новый бета-метод для получения списка отправлений FBP.
/v1/carriage/get	Обновили описание параметра available_actions в ответе метода.
/v1/warehouse/list	Добавили параметр with.able_to_set_price в запрос метода.
Добавили параметры result.is_able_to_set_price и result.is_presorted в ответ метода.
/v3/posting/fbs/unfulfilled/list	Добавили параметр filter.last_changed_status_date в запрос метода.
Добавили параметры result.postings.is_presortable, result.postings.destination_place_id, result.postings.destination_place_name и result.postings.customer.customer_email в ответ метода.
/v3/posting/fbs/list	Добавили параметры result.postings.is_presortable, result.postings.destination_place_id, result.postings.destination_place_name и result.postings.customer.customer_email в ответ метода.
/v3/supply-order/get	Изменили название параметров orders.data_filling_deadline на orders.data_filling_deadline_utc и orders.drop_off_warehouse на orders.dropoff_warehouse в ответе метода.
29 апреля 2026
Метод	Изменение
/v1/product/prices/details	В ответе метода:
...
28 апреля 2026
Метод	Изменение
/v1/warehouse/erfbs/non-integrated/create	Обновили описание параметра min_order_value в запросе метода.
24 апреля 2026
Метод	Изменение
/v1/fbp/draft/drop-off/product/validate
/v1/fbp/draft/direct/product/validate
/v1/fbp/draft/pick-up/product/validate	Добавили значения NO_SALES, SURPLUS и AVAILABILITY_IS_EMPTY параметра rejected_items.rejection_reasons в ответе методов.
/v1/fbp/draft/drop-off/registrate
/v1/fbp/draft/direct/registrate
/v1/fbp/draft/pick-up/registrate	Добавили значения NO_SALES, SURPLUS и AVAILABILITY_IS_EMPTY параметра error.bundle_errors.errors в ответе методов.
20 апреля 2026
Метод	Изменение
/v1/review/comment/list	Обновили название метода.
Добавили параметр filter в запрос метода.
Добавили параметры comments.deviation_reason, comments.dislikes_amount, comments.is_published, comments.is_rejected и comments.likes_amount в ответ метода.
/v2/review/comment/delete	Добавили новую версию метода для удаления комментария на отзыв.
/v1/review/comment/delete	Метод устаревает и будет отключён в будущем. Переключитесь на /v2/review/comment/delete.
/v2/review/change-status	Добавили новую версию метода для изменения статуса отзывов.
/v1/review/change-status	Метод устаревает и будет отключён в будущем. Переключитесь на /v2/review/change-status.
/v2/review/count	Добавили новую версию метода для получения количества отзывов по статусам.
/v1/review/count	Метод устаревает и будет отключён в будущем. Переключитесь на /v2/review/count.
/v2/review/info	Добавили новую версию метода для получения информации об отзыве.
/v1/review/info	Метод устаревает и будет отключён в будущем. Переключитесь на /v2/review/info.
/v2/review/list	Добавили новую версию метода для получения списка отзывов.
/v1/review/list	Метод устаревает и будет отключён в будущем. Переключитесь на /v2/review/list.
/v1/question/answer/list	Добавили параметр answers.status_publication в ответ метода.
/v1/question/list	Добавили параметры sort_dir и limit в запрос метода.
Добавили параметр has_next в ответ метода.
17 апреля 2026
Метод	Изменение
—	В разделе Пуш-уведомления → Новое сообщение в чате, Сообщение в чате изменено, Ваше сообщение прочитано и Чат закрыт обновили значения параметра chat_type.
15 апреля 2026
Метод	Изменение
/v1/seller/ozon-logistics/info	Обновили название метода.
Обновили описание параметра ozon_logistics_enabled в ответе метода.
/v3/posting/fbs/get
/v2/posting/fbo/list
/v2/posting/fbo/get	Обновили описание параметров result.analytics_data.client_delivery_date_begin и result.analytics_data.client_delivery_date_end в ответе методов.
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Обновили описание параметров result.postings.analytics_data.client_delivery_date_begin и result.postings.analytics_data.client_delivery_date_end в ответе методов.
/v3/chat/list	Обновили описание параметра chats.chat.chat_type в ответе метода.
—	Изменили название раздела Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Ozon Логистика на Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Ozon Доставка.
Изменили название раздела Ozon Логистика на Ozon Доставка.
14 апреля 2026
Метод	Изменение
/v1/seller-actions/create/ozon-card-discount
/v1/seller-actions/update/ozon-card-discount	Акция недоступна для использования, удалили методы из документации.
8 апреля 2026
Метод	Изменение
/v1/notification/set
/v1/notification/update
...
/v1/notification/enable
/v1/notification/list
/v1/notification/push-type/list	Добавили бета-методы для работы с пуш-уведомлениями.
7 апреля 2026
Метод	Изменение
/v2/warehouse/list	Добавили параметр warehouses.pause_at в ответ метода.
/v1/warehouse/operation/status	Обновили значение параметра type в ответе метода.
/v1/warehouse/rfbs/pause
/v1/warehouse/rfbs/unpause	Добавили бета-методы для включения и выключения паузы на rFBS-складе.
6 апреля 2026
Метод	Изменение
/v1/product/visibility/set	Добавили бета-метод для настройки видимости товара на витрине Ozon и Ozon Селект.
/v3/posting/fbs/get	Добавили параметр result.tariffication_steps в ответ метода.
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Добавили параметр result.postings.tariffication_steps в ответ методов.
31 марта 2026
Метод	Изменение
/v1/review/comment/create
/v1/review/comment/delete
...
/v1/review/count
/v1/review/info
/v1/review/list	Обновили описание методов.
26 марта 2026
Метод	Изменение
/v3/product/import
/v1/product/import-by-sku
/v1/product/attributes/update
/v1/product/pictures/import
/v1/product/update/offer-id	Обновили описание методов.
24 марта 2026
Метод	Изменение
/v1/product/info/stocks-by-warehouse/fbs	Метод устаревает и будет отключён 7 апреля 2026 года. Переключитесь на /v2/product/info/stocks-by-warehouse/fbs.
/v1/delivery-method/list	Метод устаревает и будет отключён 7 апреля 2026 года. Переключитесь на /v2/delivery-method/list.
/v1/warehouse/list	Метод устаревает и будет отключён 7 апреля 2026 года. Переключитесь на /v2/warehouse/list.
/v1/analytics/stocks	Перенесли метод из бета-раздела в основной.
Обновили описание метода.
/v3/product/import	В описание метода добавили информацию о загрузке главного изображения для Ozon Селект.
17 марта 2026
Метод	Изменение
/v1/analytics/average-delivery-time
/v1/analytics/average-delivery-time/details
/v1/analytics/average-delivery-time/summary	Обновили описание методов.
/v1/product/update/offer-id	Обновили описание метода. Добавили лимиты для параметра update_offer_id в запрос метода.
/v2/posting/fbo/list
/v2/posting/fbo/get	Обновили описание параметров result.analytics_data.client_delivery_date_begin и result.analytics_data.client_delivery_date_end в ответе методов.
/v3/posting/fbs/get	Обновили описание параметров result.analytics_data.client_delivery_date_begin и result.analytics_data.client_delivery_date_end в ответе метода.
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Обновили описание параметров result.postings.analytics_data.client_delivery_date_begin и result.postings.analytics_data.client_delivery_date_end в ответе методов.
13 марта 2026
Метод	Изменение
/v3/chat/list	Обновили описание параметра chats.chat.chat_type в ответе метода.
/v3/chat/history	Обновили описание параметра messages.user.type в ответе метода.
12 марта 2026
Метод	Изменение
/v1/warehouse/ozon/list	Добавили бета-метод для получения списка складов Ozon.
11 марта 2026
Метод	Изменение
/v3/chat/list	Обновили описание параметра chats.chat.chat_type в ответе метода.
10 марта 2026
Метод	Изменение
/v1/warehouse/fbs/create/return-point/list
/v1/warehouse/fbs/update/return-point/list	Обновили описание параметров search.types в запросе и points.type в ответе методов.
/v1/warehouse/fbs/return-mile/info	Обновили описание параметра return_mile_settings.return_point.type в ответе метода.
/v2/posting/fbs/package-label/create	Обновили описание метода.
/v1/cargoes-label/get	В ответе метода:
• добавили параметр result.file_url;
• пометили устаревшим параметр result.file_guid.
/v1/cargoes-label/file/{file_guid}	Метод устаревает и будет отключён 10 апреля 2026 года. Переключитесь на /v1/cargoes-label/get.
—	В разделе Частые ошибки добавили описание ошибки INCORRECT_OVH_FOR_POSTING для метода /v4/posting/fbs/ship.
/v2/order/create	Добавили параметр splits.items.offer_id в запрос метода.
/v2/delivery/checkout	Добавили параметр items.offer_id в запрос метода и splits.items.offer_id в ответ метода.
/v2/cluster/list	Добавили бета-метод для получения информации о макролокальных кластерах.
/v1/analytics/stocks	Добавили параметр macrolocal_cluster_ids в запрос метода.
Добавили параметр items.macrolocal_cluster_id в ответ метода.
6 марта 2026
Метод	Изменение
—	Изменили название раздела Порядок работы с методами → Участвуйте в акциях на Порядок работы с методами → Участвуйте в акциях Ozon.
...
/v1/returns/settings/utilization/update
/v1/cargoes/get
/v1/product/prices/details	Перенесли методы из бета-раздела в основной.
2 марта 2026
Метод	Изменение
/v1/seller-actions/create/discount
/v1/seller-actions/create/discount-with-condition
...
/v1/seller-actions/change-activity
/v1/seller-actions/list
/v1/seller-actions/voucher/get	Добавили бета-методы для работы с акциями продавца.
/v1/draft/create
/v1/draft/create/info
/v1/draft/timeslot/info
/v1/draft/supply/create
/v1/draft/supply/create/status	Методы устаревают и будут отключены 16 марта 2026 года.
/v2/draft/create/info	• Добавили параметр clusters.supply_type в ответ метода.
• Добавили значение MINIMUM_VOLUME_IN_LITRES_INVALID параметра errors.error_reasons в ответе метода.
• Обновили описание параметров clusters.warehouses.storage_warehouse и clusters.warehouses.total_rank в ответе метода.
/v2/draft/timeslot/info	• Добавили параметр supply_type в запрос метода.
• Добавили значение INVALID_REQUESTED_CLUSTER_IDS параметра error_reason в ответе метода.
• Обновили описание параметров selected_cluster_warehouses и selected_cluster_warehouses.storage_warehouse_id в запросе метода.
/v2/draft/supply/create	• Добавили параметр supply_type в запрос метода.
• Добавили значение MINIMUM_VOLUME_IN_LITRES_INVALID параметра error_reasons в ответе метода.
• Обновили описание параметра selected_cluster_warehouses.storage_warehouse_id в запросе метода.
/v3/supply-order/get	Добавили параметр supplies.macrolocal_cluster_id в ответ метода.
/v1/supply-order/details	• Добавили параметр supplies.macrolocal_cluster_id в ответ метода.
...
/v2/draft/supply/create
/v2/draft/supply/create/status
/v1/warehouse/fbo/seller/list	Перенесли методы из бета-раздела в основной.
26 февраля 2026
Метод	Изменение
/v3/product/info/list	Обновили описание параметра items.is_kgt в ответе метода.
/v1/carriage/act-discrepancy/pdf	Добавили бета-метод для получения акта о расхождениях по отгрузке FBS.
—	В разделах Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Схема FBS Стандарт и Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Схема FBS PickUp с доверительной приёмкой обновили порядок работы с PDF-документами.
—	В разделе Порядок работы с методами → Получите информацию о складах обновили описание работы с методами.
24 февраля 2026
Метод	Изменение
/v1/draft/crossdock/create
/v1/draft/multi-cluster/create	Обновили описание параметра delivery_info.drop_off_warehouse.warehouse_type в запросе методов.
20 февраля 2026
Метод	Изменение
—	В разделе Авторизация через API-ключ обновили информацию о работе с API-ключом.
/v1/roles	Добавили параметр expires_at в ответ метода.
/v2/chat/history	Метод устарел, удалили его из документации. Используйте /v3/chat/history.
17 февраля 2026
Метод	Изменение
/v1/fbp/draft/direct/seller-dlv/create	Пометили обязательными параметры bundle_id, delivery_details, delivery_details.driver_name, delivery_details.timeslot_start, delivery_details.vehicle_number, delivery_details.vehicle_type, package_units_count и warehouse_id в запросе метода.
/v1/fbp/draft/direct/seller-dlv/edit	Пометили обязательными параметры driver_name, row_version, supply_id, vehicle_number и vehicle_type в запросе метода.
/v1/fbp/draft/direct/timeslot/edit	Пометили обязательными параметры row_version, supply_id и timeslot_start в запросе метода.
/v1/fbp/draft/direct/timeslot/get	Пометили обязательными параметры bundle_id, interval_end, interval_start и warehouse_id в запросе метода.
/v1/fbp/draft/direct/create	Пометили обязательными параметры bundle_id, delivery_details, delivery_details.timeslot_start, package_units_count и warehouse_id в запросе метода.
/v1/fbp/draft/direct/delete
/v1/fbp/draft/drop-off/delete
/v1/fbp/draft/pick-up/delete
/v1/fbp/order/direct/cancel	Пометили обязательным параметр supply_id в запросе методов.
/v1/fbp/draft/direct/product/validate
/v1/fbp/draft/drop-off/product/validate
/v1/fbp/draft/pick-up/product/validate	Пометили обязательными параметры skus, skus.count, skus.sku и warehouse_id в запросе методов.
/v1/fbp/draft/direct/registrate
/v1/fbp/draft/drop-off/registrate
/v1/fbp/draft/pick-up/registrate	Пометили обязательными параметры row_version и supply_id в запросе методов.
/v1/fbp/draft/direct/tpl-dlv/create	Пометили обязательными параметры bundle_id, delivery_details, delivery_details.timeslot_start, delivery_details.tracking_number, delivery_details.transport_company_name, package_units_count и warehouse_id в запросе метода.
/v1/fbp/draft/direct/tpl-dlv/edit	Пометили обязательными параметры row_version, supply_id, tracking_number и transport_company_name в запросе метода.
/v1/fbp/draft/drop-off/create	Пометили обязательными параметры bundle_id, delivery_details, delivery_details.drop_off_date, delivery_details.drop_off_point_id, delivery_details.drop_off_province_uuid, package_units_count и warehouse_id в запросе метода.
/v1/fbp/draft/drop-off/dlv/edit	Пометили обязательными параметры drop_off_date, drop_off_point_id, drop_off_province_uuid, row_version и supply_id в запросе метода.
/v1/fbp/draft/drop-off/province/list	Пометили обязательным параметр warehouse_id в запросе метода.
/v1/fbp/draft/drop-off/point/list	Пометили обязательными параметры page_size, province_uuid и warehouse_id в запросе метода.
/v1/fbp/draft/drop-off/point/timetable	Пометили обязательными параметры drop_off_point_id, province_uuid и warehouse_id в запросе метода.
/v1/fbp/draft/pick-up/create	Пометили обязательными параметры bundle_id, delivery_details, delivery_details.address, delivery_details.comment, delivery_details.date, delivery_details.sender_name, delivery_details.sender_phone, package_units_count и warehouse_id в запросе метода.
/v1/fbp/draft/pick-up/dlv/edit	Пометили обязательными параметры row_version, supply_id, pickup_details, pickup_details.address, pickup_details.comment, pickup_details.date, pickup_details.sender_name и pickup_details.sender_phone в запросе метода.
16 февраля 2026
Метод	Изменение
/v1/warehouse/list	Метод устаревает и будет отключён 20 марта 2026 года. Переключитесь на /v2/warehouse/list.
/v1/posting/carriage-available/list
/v1/carriage/delivery/list	Методы устаревают и будут отключены 20 марта 2026 года. Переключитесь на /v2/carriage/delivery/list.
/v3/posting/fbs/get	Добавили параметр result.addressee.pin в ответ метода.
12 февраля 2026
Метод	Изменение
/v1/returns/rfbs/action/set	Пометили обязательным параметр return_id в запросе метода.
/v1/chat/send/file	Пометили обязательными параметры base64_content и name в запросе метода.
/v2/report/returns/create	Пометили обязательным параметр filter в запросе метода.
/v1/report/postings/create	Пометили обязательными параметры filter.processed_at_from и filter.processed_at_to в запросе метода.
/v1/report/marked-products-sales/create	Пометили обязательными параметры date.from и date.to в запросе метода.
/v1/finance/document-b2b-sales
/v1/finance/document-b2b-sales/json
/v1/finance/mutual-settlement	Пометили обязательным параметр date в запросе методов.
/v1/product/info/wrong-volume
/v1/product/quant/list
/v1/warehouse/fbs/pickup/history/list	Пометили обязательным параметр limit в запросе методов.
/v1/product/stairway-discount/by-quantity/set	Пометили обязательными параметры stairways, stairways.enabled, stairways.sku, stairways.stairway, stairways.stairway.steps, stairways.stairway.steps.discount, stairways.stairway.steps.quantity и stairways.stairway.steps.step в запросе метода.
/v1/product/stairway-discount/by-quantity/get
/v1/product/placement-zone/info
/v1/product/prices/details	Пометили обязательным параметр skus в запросе методов.
/v2/draft/supply/create	Пометили обязательными параметры timeslot, timeslot.from_in_timezone и timeslot.to_in_timezone в запросе метода.
/v1/warehouse/fbs/update	Пометили обязательным параметр address_coordinates в запросе метода.
/v1/warehouse/fbs/pickup/courier/create
/v1/warehouse/fbs/pickup/courier/cancel	Пометили обязательным параметр warehouse_id в запросе методов.
/v1/actions/discounts-task/list	Пометили обязательным параметр page в запросе метода.
/v1/fbp/draft/get	Пометили обязательным параметр supply_id в запросе метода.
/v1/fbp/draft/list	Пометили обязательным параметр count в запросе метода.
/v1/fbp/order/direct/seller-dlv/edit	Пометили обязательными параметры driver_name, row_version, supply_id, vehicle_number и vehicle_type в запросе метода.
/v1/fbp/order/direct/timeslot/edit	Пометили обязательными параметры row_version, supply_id и timeslot_start в запросе метода.
/v1/fbp/order/direct/timeslot/list	Пометили обязательными параметры interval_end, interval_start и supply_id в запросе метода.
/v1/fbp/order/drop-off/cancel
/v1/fbp/order/pick-up/cancel
/v1/fbp/act-from/create
/v1/fbp/act-to/create
/v1/fbp/order/get	Пометили обязательным параметр supply_id в запросе методов.
/v1/fbp/order/drop-off/dlv/edit	Пометили обязательными параметры drop_off_date, row_version и supply_id в запросе метода.
/v1/fbp/order/drop-off/timetable	Пометили обязательными параметры drop_off_point_id, province_uuid и warehouse_id в запросе метода.
/v1/fbp/order/pick-up/dlv/edit	Пометили обязательными параметры pickup_details, pickup_details.sender_name, pickup_details.sender_phone, row_version и supply_id в запросе метода.
/v1/fbp/act-from/get	Пометили обязательным параметр file_uuid в запросе метода.
/v1/fbp/act-to/get	Пометили обязательными параметры code и supply_id в запросе метода.
/v1/fbp/order/list	Пометили обязательным параметр count в запросе метода.
/v1/cancel-reason/list-by-order	Пометили обязательным параметр order_number в запросе метода.
/v1/cancel-reason/list-by-posting	Пометили обязательным параметр posting_number в запросе метода.
/v1/delivery/check	Пометили обязательным параметр client_phone в запросе метода.
/v2/product/info/stocks-by-warehouse/fbs	Пометили обязательным параметр limit в запросе метода.
/v1/draft/crossdock/create
/v1/draft/direct/create
/v1/draft/multi-cluster/create	Обновили описание методов.
/v1/product/import-by-sku	Обновили описание метода.
/v2/draft/timeslot/info
/v2/draft/create/info	Обновили описание методов.
Обновили описание параметра draft_id в запросе методов.
/v2/draft/supply/create	Обновили описание параметра draft_id в запросе метода.
10 февраля 2026
Метод	Изменение
/v3/product/list
/v4/product/info/attributes
...
9 февраля 2026
Метод	Изменение
/v3/supply-order/get	Отметили устаревшим параметр orders.supplies.storage_warehouse.arrival_date в ответе метода.
/v1/supply-order/details	Отметили устаревшим параметр supplies.storage_warehouse.arrival_date в ответе метода.
/v2/posting/fbs/act/create	Обновили описание параметра delivery_method_id в запросе метода.
/v2/carriage/delivery/list	Обновили описание параметра filter.delivery_method_id в запросе метода.
/v2/delivery-method/list	Изменили название метода.
/v2/order/create	Пометили обязательными параметры delivery_schema, splits.delivery_method, splits.delivery_method.delivery_method_id, splits.delivery_method.delivery_type, splits.delivery_method.timeslot_id, splits.delivery_method.logistic_date_range, splits.delivery_method.logistic_date_range.from, splits.delivery_method.logistic_date_range.to, splits.items, items.price, items.quantity, items.sku, splits.warehouse_id, delivery.courier.city, delivery.courier.country, delivery.courier.house_number и delivery.pick_up.map_point_id в запросе метода.
5 февраля 2026
Метод	Изменение
/v1/product/certificate/bind	Пометили обязательными параметры product_id и certificate_id в запросе метода.
/v2/posting/fbs/get-by-barcode	Пометили обязательным параметр barcode в запросе метода.
/v2/posting/fbs/cancel	Пометили обязательными параметры cancel_reason_id и posting_number в запросе метода.
/v1/posting/unpaid-legal/product/list	Пометили обязательным параметр limit в запросе метода.
/v1/cargoes/delete	Пометили обязательными параметры cargo_ids и supply_id в запросе метода.
/v1/cargoes/delete/status	Пометили обязательным параметр operation_id в запросе метода.
/v1/cargoes/rules/get	Пометили обязательным параметр supply_ids в запросе метода.
/v1/supply-order/content/update	Пометили обязательными параметры order_id, supply_id, items, items.quant, items.quantity и items.sku в запросе метода.
/v1/supply-order/content/update/status	Пометили обязательным параметр operation_id в запросе метода.
/v6/fbs/posting/product/exemplar/set	Пометили обязательными параметры posting_number, products, products.product_id, products.exemplars и products.exemplars.exemplar_id в запросе метода.
/v5/fbs/posting/product/exemplar/status
/v6/fbs/posting/product/exemplar/create-or-get
/v1/fbs/posting/product/exemplar/update	Пометили обязательным параметр posting_number в запросе методов.
/v5/fbs/posting/product/exemplar/validate	Пометили обязательными параметры posting_number, products.product_id и products.exemplars в запросе метода.
/v1/carriage/set-postings	Пометили обязательными параметры carriage_id и posting_numbers в запросе метода.
/v1/carriage/cancel	Пометили обязательным параметр carriage_id в запросе метода.
/v1/assembly/carriage/posting/list
/v1/assembly/carriage/product/list	Пометили обязательным параметр filter.carriage_id в запросе методов.
/v1/assembly/fbs/posting/list	Пометили обязательными параметры sort_dir, filter.cutoff_from и filter.cutoff_to в запросе метода.
/v1/assembly/fbs/product/list	Пометили обязательными параметры filter.cutoff_from и filter.cutoff_to в запросе метода.
3 февраля 2026
Метод	Изменение
/v1/report/info	Обновили описание параметра result.report_type в ответе метода.
/v1/report/list	Обновили описание параметра report_type в запросе метода.
...
/v1/warehouse/erfbs/non-integrated/delivery-method/update
/v1/warehouse/erfbs/update
/v2/polygon/bind	Перенесли методы из бета-раздела в основной.
/v2/posting/fbs/act/create
/v1/posting/carriage-available/list	Обновили описание параметра delivery_method_id в запросе методов.
27 января 2026
Метод	Изменение
—	В разделах Порядок работы с методами → Обновите цены и остатки товаров и Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP обновили описание работы с методами.
/v4/product/info/stocks	Обновили описание метода.
26 января 2026
Метод	Изменение
/v2/posting/fbo/get
/v3/posting/fbs/get	Добавили параметры result.fact_delivery_date и result.financial_data.products.customer_currency_code в ответ методов.
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Добавили параметр result.postings.financial_data.products.customer_currency_code в ответ методов.
23 января 2026
Метод	Изменение
/v1/returns/settings/utilization/history
/v1/returns/settings/utilization/info
/v1/returns/settings/utilization/update	Добавили бета-методы для работы с автоутилизацией.
/v2/actions/discounts-task/list	Добавили бета-метод для получения списка заявок на скидку.
/v1/actions/discounts-task/list	Метод устаревает и будет отключён в будущем. Переключитесь на /v2/actions/discounts-task/list.
22 января 2026
Метод	Изменение
/v1/report/products/create	Обновили описание параметра visibility в запросе метода.
/v1/report/placement/by-products/create
/v1/report/placement/by-supplies/create	Обновили описание методов.
/v2/order/create	В запросе метода:
...
/v1/carriage/approve	Обновили описание метода.
/v1/carriage/get	Обновили описание параметра available_actions в ответе метода.
/v2/posting/fbs/digital/act/check-status	Метод устаревает и будет отключён 22 марта 2026 года. Переключитесь на /v2/posting/fbs/act/check-status.
/v2/posting/fbs/act/get-pdf	Обновили описание метода.
Обновили описание параметра id в запросе метода.
/v2/posting/fbs/digital/act/get-pdf	Метод устаревает и будет отключён 22 марта 2026 года. Переключитесь на /v2/posting/fbs/act/get-pdf.
/v2/posting/fbs/act/check-status	Обновили описание параметра result.act_type в ответе метода.
—	В разделах Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Схема FBS Стандарт и Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Схема FBS PickUp с доверительной приёмкой обновили порядок работы с файлами.
20 января 2026
Метод	Изменение
/v2/fbs/posting/sent-by-seller	Метод устарел, удалили его из документации.
—	В разделах Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Схема rFBS Crossborder и Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Схема rFBS Crossborder с интегрированной службой доставки обновили описание работы с методами.
16 января 2026
Метод	Изменение
/v1/draft/crossdock/create
/v1/draft/direct/create
...
/v2/draft/supply/create
/v2/draft/supply/create/status
/v1/warehouse/fbo/seller/list	Добавили бета-методы для работы с заявками на поставку FBO.
/v1/cargoes/get	Добавили бета-метод для получения информации о грузоместах.
/v3/supply-order/get	Добавили параметры orders.order_tags.is_pickup и orders.order_tags.seller_warehouse_id в ответ метода.
/v1/supply-order/timeslot/update
/v1/supply-order/timeslot/status	Обновили описание параметра errors в ответе методов.
/v1/report/info	Обновили описание параметра result.report_type в ответе метода.
/v1/report/list	Обновили описания параметров report_type в запросе метода и result.reports.report_type в ответе метода.
15 января 2026
Метод	Изменение
/v1/product/prices/details	Добавили бета-метод для получения подробной информации о цене товаров.
13 января 2026
Метод	Изменение
...
/v2/supply-order/get	Методы устарели, удалили их из документации.
30 декабря 2025
Метод	Изменение
/v1/report/marked-products-sales/create
/v1/posting/fbs/traceable/split
...
/v1/assembly/fbs/product/list
/v1/seller/info
/v1/seller/ozon-logistics/info	Перенесли методы из бета-раздела в основной.
/v1/product/import/prices	Обновили описание параметра prices.vat в запросе метода.
/v1/product/import-by-sku
/v3/product/import	Обновили описание параметра items.vat в запросе методов.
26 декабря 2025
Метод	Изменение
/v2/returns/rfbs/list
/v2/returns/rfbs/list	Параметр returns.client_name в ответе метода устаревает, отключим его 2 февраля 2026 года.
25 декабря 2025
Метод	Изменение
/v1/report/placement/by-products/create	Добавили метод для получения отчёта о стоимости размещения по товарам.
/v1/report/placement/by-supplies/create	Добавили метод для получения отчёта о стоимости размещения по поставкам.
/v1/product/placement-zone/info	Добавили бета-метод для получения информации о зонах размещения товаров по их SKU перед поставкой.
/v1/report/info	Обновили описание параметра result.report_type в ответе метода.
/v1/report/list	Обновили описание параметра report_type в запросе метода.
Обновили описание параметра result.reports.report_type в ответе метода.
/v2/finance/realization	Удалили параметры result.header.doc_amount и result.header.vat_amount из ответа метода.
/v1/finance/realization/posting	Удалили параметры header.doc_amount и header.vat_amount из ответа метода.
/v5/fbs/posting/product/exemplar/status	Обновили описание параметра products.exemplars.marks.check_status в ответе метода.
/v5/product/info/prices	Обновили описание параметра items.price.retail_price в ответе метода.
/v3/product/list	Обновили описание параметра result.items.quants в ответе метода.
/v2/posting/fbs/product/change	Метод устарел, удалили его из документации.
23 декабря 2025
Метод	Изменение
/v1/product/unarchive	Обновили описание параметра product_id в запросе метода.
18 декабря 2025
Метод	Изменение
/v1/warehouse/fbs/pickup/courier/create	Добавили бета-метод для вызова курьера на забор отгрузки pick-up со склада FBS.
/v1/warehouse/fbs/pickup/courier/cancel	Добавили бета-метод для отмены вызова курьера на забор отгрузки pick-up со склада FBS.
/v1/warehouse/fbs/pickup/planning/list	Добавили бета-метод для получения списка складов для планирования отгрузок курьеру.
/v1/receipts/get
/v1/receipts/seller/list
/v1/receipts/upload	Добавили методы для работы с чеками.
16 декабря 2025
Метод	Изменение
/v1/warehouse/fbs/pickup/history/list	Добавили бета-метод для работы с историей отгрузок курьерам.
/v5/fbs/posting/product/exemplar/status	Обновили описание параметра status в ответе метода.
/v2/warehouse/list	Добавили параметр has_next в ответ метода.
15 декабря 2025
Метод	Изменение
/v1/warehouse/warehouses-with-invalid-products	Добавили бета-метод для получения списка складов, на которых есть товары с ограничениями по доставке rFBS.
/v1/warehouse/invalid-products/get	Добавили бета-метод для получения списка товаров с ограничениями по доставке rFBS.
12 декабря 2025
Метод	Изменение
...
/v1/posting/digital/codes/upload
/v1/posting/digital/list
/v1/product/digital/stocks/import	Перенесли методы из бета-раздела в основной.
9 декабря 2025
Метод	Изменение
...
/v1/warehouse/fbs/update/return-point/list
/v1/warehouse/fbs/return-mile/info
/v1/warehouse/fbs/return-mile/check	Добавили бета-методы для работы с FBS-складами.
/v1/warehouse/fbs/create
/v1/warehouse/unarchive
/v1/warehouse/archive
/v1/warehouse/fbs/first-mile/update	Добавили параметр return_point_id в запрос метода.
...
/v1/posting/carriage-available/list
/v1/carriage/delivery/list	Методы устаревают и будут отключены с 2 февраля 2026 года. Переключитесь на /v2/carriage/delivery/list.
...
Метод	Изменение
/v1/actions/candidates
/v1/actions/products	Добавили параметры result.products.current_boost, result.products.price_min_elastic, result.products.price_max_elastic, result.products.min_boost и result.products.max_boost.
/v2/posting/fbo/list
/v2/posting/fbo/get	В ответе методов:
обновили описание параметра result.analytics_data.payment_type_group_name;
...
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	В ответе методов:
обновили описание параметра result.postings.analytics_data.payment_type_group_name;
...
/v2/warehouse/list	Добавили параметры limit и cursor в запрос метода.
Добавили параметр cursor в ответ метода.
/v1/warehouse/list	Добавили параметры limit и offset в запрос метода.
/v4/product/info/stocks	Пометили устаревшим параметр items.stocks.warehouse_ids в ответе метода.
/v1/report/warehouse/stock	Обновили описание параметра warehouseId в запросе метода.
/v1/cancel-reason/list
/v1/cancel-reason/list-by-order
/v1/cancel-reason/list-by-posting	Добавили описание методов.
Обновили описание параметра reasons.id в ответе методов.
/v1/delivery/check	Добавили описание метода.
...
/v2/order/create
/v1/posting/cancel
/v1/posting/marks	Добавили описание методов.
—	В разделе Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Ozon Логистика обновили порядок работы с возвратами.
25 ноября 2025
Метод	Изменение
...
Метод	Изменение
/v1/rating/index/fbs/info
/v1/rating/index/fbs/posting/list	Добавили бета-методы для работы с индексом ошибок FBS и rFBS.
/v1/returns/list	Добавили параметр filter.compensation_status_id в запрос метода.
...
/v1/analytics/average-delivery-time
/v1/analytics/average-delivery-time/details
/v1/analytics/average-delivery-time/summary	Перенесли методы из бета-раздела в основной.
12 ноября 2025
Метод	Изменение
...
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Добавили параметр result.postings.require_blr_traceable_attrs в ответ метода.
...
/v1/polygon/list
/v1/polygon/time/coordinates/update
/v1/polygon/time/set	Добавили бета-методы для работы со складами rFBS Express.
5 ноября 2025
Метод	Изменение
...
/v1/assembly/carriage/product/list
/v1/assembly/fbs/posting/list
/v1/assembly/fbs/product/list	Добавили бета-методы для работы с листами подбора FBS.
/v3/supply-order/list
/v3/supply-order/get
/v1/supply-order/content/update/validation
/v1/product/info/warehouse/stocks	Перенесли методы из бета-раздела в основной.
/v2/supply-order/list
/v2/supply-order/get	Методы устаревают и будут отключены 11 декабря 2025 года. Переключитесь на новые версии — /v3/supply-order/list и /v3/supply-order/get.
...
/v3/posting/fbs/unfulfilled/list
/v3/posting/fbs/list	Обновили описание параметра result.postings.substatus в ответе методов.
/v4/posting/fbs/ship
/v4/posting/fbs/ship/package	Обновили описание методов.
...
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Добавили параметр result.postings.shipment_date_without_delay в ответ методов.
...
Метод	Изменение
/v1/draft/create
/v1/draft/create/info	Обновили описание методов.
...
/v2/posting/fbo/get
/v2/posting/fbo/list
/v1/posting/digital/list	Обновили описание параметра result.financial_data.products.product_id в ответе метода.
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Обновили описание параметра result.postings.financial_data.products.product_id в ответе метода.
...
/v1/warehouse/fbs/update/drop-off/timeslot/list
/v1/warehouse/fbs/create/pick-up/timeslot/list
/v1/warehouse/fbs/update/pick-up/timeslot/list	Добавили бета-методы для работы с таймслотами.
...
/v1/warehouse/fbs/create
/v1/warehouse/fbs/first-mile/update	Добавили параметры сut_in_time и timeslot_id в запрос методов.
10 октября 2025
Метод	Изменение
/v5/product/info/prices	Добавили параметры items.comissions.sales_percent_fbp и items.comissions.sales_percent_rfbs в ответ метода.
Добавили возможное значение SUPER параметра items.price_indexes.color_index в ответе метода.
...
/v3/product/import	Обновили описание параметра items.images в запросе метода.
Обновили описание метода.
/v1/product/pictures/import	Обновили описание параметра images в запросе метода.
Обновили описание метода.
7 октября 2025
Метод	Изменение
v1/removal/from-stock/list
v1/removal/from-supply/list	Обновили примеры ответов.
/v1/question/info	Обновили название метода.
Обновили описание и пример ответа метода.
/v1/question/top-sku	Обновили описание ответа метода.
...
/v1/search-queries/text
/v1/search-queries/top	Добавили методы для работы с поисковыми запросами.
/v1/analytics/data
/v1/chat/send/message
/v1/chat/send/file
/v1/chat/start
...
/v5/fbs/posting/product/exemplar/set
/v4/fbs/posting/product/exemplar/status
/v4/fbs/posting/product/exemplar/validate	Методы устаревают и будут отключены 3 декабря 2025 года. Переключитесь на новые версии.
...
/v2/chat/history
/v3/chat/history	Обновили описание параметра from_message_id в запросе методов.
...
/v1/analytics/product-queries
/v1/analytics/product-queries/details	Обновили описание параметров page и page_size в запросе методов. Обновили пример запроса.
...
/v1/cargoes/create
/v1/cargoes/create/info	Обновили описание параметра items.value.barcode в запросе методов.
/v3/product/import	Пометили параметр items.price как обязательный в запросе метода.
...
/v2/posting/fbs/package-label
/v2/posting/fbs/package-label/create
/v1/posting/digital/codes/upload	Обновили описание методов.
...
/v1/supply-order/content/update/status	В ответе метода:
...
—	Удалили раздел Пуш-уведомления → Уведомления, которые отправляет Ozon → Изменение ценового индекса товара.
Удалили уведомление TYPE_PRICE_INDEX_CHANGED из раздела Пуш-уведомления → Уведомления, которые отправляет Ozon.
15 сентября 2025
Метод	Изменение
...
Метод	Изменение
v3/posting/fbs/unfulfilled/list
v3/posting/fbs/list	Добавили параметры result.postings.products.imei и result.postings.requirements.products_requiring_imei в ответ метода.
...
/v1/conditional-cancellation/list	Методы устарели, удалили их из документации. Используйте /v2/conditional-cancellation/list.
...
Метод	Изменение
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Добавили параметр result.postings.requirements.products_requiring_weight в ответ методов.
...
—	В разделах Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Схема rFBS Стандарт и Порядок работы с методами → Управляйте заказами FBO, FBS, rFBS и FBP → Как работать с заказами с весовыми товарами (rFBS) обновили описание работы с методами.
27 августа 2025
Метод	Изменение
...
/v1/warehouse/fbs/first-mile/update
/v1/warehouse/archive
/v1/warehouse/unarchive	Добавили бета-методы для работы с FBS-складами.
...
/v1/carriage/cancel
/v1/product/action/timer/status
/v1/product/action/timer/update	Перенесли методы из бета-раздела в основной.
5 августа 2025
Метод	Изменение
/v1/chat/send/file
/v1/chat/send/message	Обновили описание методов.
/v3/product/info/list	Пометили параметр items.is_prepayment_allowed в ответе метода как устаревший.
1 августа 2025
Метод	Изменение
/v1/finance/cash-flow-statement/list
/v3/finance/transaction/list
/v3/finance/transaction/totals	Обновили описания методов.
30 июля 2025
Метод	Изменение
...
/v1/finance/realization/posting
/v2/finance/realization	Обновили описание методов.
23 июля 2025
Метод	Изменение
/v1/analytics/product-queries
/v1/analytics/product-queries/details
/v1/finance/compensation
/v1/finance/decompensation	Перенесли методы из бета-раздела в основной.
22 июля 2025
Метод	Изменение
...
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Обновили описание параметров result.postings.requirements.products_requiring_change_country и result.postings.financial_data.products.actions в ответе методов.
/v3/posting/fbs/get
/v2/posting/fbo/get
/v2/posting/fbo/list	Обновили описание параметра result.financial_data.products.actions в ответе методов.
21 июля 2025
Метод	Изменение
/v1/finance/products/buyout
/v1/finance/document-b2b-sales/json	Перенесли методы из бета-раздела в основной.
15 июля 2025
Метод	Изменение
...
/v3/posting/fbs/unfulfilled/list
/v3/posting/fbs/list	Добавили параметр result.postings.requirements.products_requiring_change_country в ответ метода.
...
/v2/posting/fbo/list
/v2/posting/fbo/get
/v3/posting/fbs/get	Добавили параметр result.products.is_marketplace_buyout в ответы методов.
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Добавили параметр result.postings.products.is_marketplace_buyout в ответы методов.
/v2/chat/history
/v3/chat/history
/v2/chat/read
/v1/chat/start
/v1/chat/send/file
/v1/chat/send/message	Обновили описания методов.
...
/v1/product/upload_digital_codes/info	Методы устарели, удалили их из документации. Используйте методы /v1/posting/digital/list, /v1/posting/digital/codes/upload и /v1/product/digital/stocks/import.
...
/v1/quant/get
/v1/quant/ship
/v1/quant/status	Методы устарели, удалили их из документации.
...
20 июня 2025
Метод	Изменение
/v1/warehouse/fbo/list	Обновили описание метода.
...
/v1/supply-order/content/update
/v1/supply-order/content/update/status
/v1/returns/rfbs/action/set	Перенесли методы из бета-раздела в основной.
—	В разделе Порядок работы с методами → Управляйте заявками на возврат rFBS-заказов обновили описание работы с методами.
/v1/draft/create/info	Обновили описание параметра operation_id в запросе метода.
Удалили параметры clusters.warehouses.warehouse_id, clusters.warehouses.address и clusters.warehouses.name из ответа метода.
/v1/question/answer/list
/v1/brand/company-certification/list
/v3/posting/fbs/list
/v1/report/list
...
/v1/review/list
/v1/question/list
/v2/supply-order/list	Обновили примеры запросов.
19 июня 2025
Метод	Изменение
...
18 июня 2025
Метод	Изменение
/v1/analytics/average-delivery-time	Добавили параметры data.metrics.exact_impact_share и total.exact_impact_share в ответ метода.
Пометили устаревшими параметры data.metrics.impact_share и total.impact_share.
...
17 июня 2025
Метод	Изменение
/v1/analytics/stocks	Добавили параметры items.ads_cluster, items.days_without_sales_cluster, items.idc_cluster и items.turnover_grade_cluster в ответ метода.
Обновили описание параметров items.ads, items.days_without_sales, items.idc и items.turnover_grade в ответе метода.
16 июня 2025
Метод	Изменение
/v1/quant/list
/v1/quant/get
/v1/quant/ship
/v1/quant/status	Методы устаревают и будут отключены 26 июня 2025 года.
...
Метод	Изменение
/v2/posting/fbo/get
/v2/posting/fbo/list	Добавили параметры with.legal_info в запрос метода и result.legal_info в ответ метода.
/v3/posting/fbs/unfulfilled/list
/v3/posting/fbs/list	Добавили параметры with.legal_info в запрос метода и result.postings.legal_info в ответ метода.
...
/v2/conditional-cancellation/list
/v2/conditional-cancellation/approve
/v2/conditional-cancellation/reject	Перенесли методы из бета-раздела в основной.
...
26 мая 2025
Метод	Изменение
/v1/analytics/stocks	Обновили описание параметра turnover_grades в запросе метода.
Обновили описание параметров items.turnover_grades и items.valid_stock_count в ответе метода.
...
/v1/cargoes/delete
/v1/cargoes/delete/status	Добавили бета-методы для удаления грузомест в заявке на поставку.
/v1/supply-order/content/update
/v1/supply-order/content/update/status	Добавили бета-методы для редактирования товарного состава в заявке на поставку.
15 мая 2025
Метод	Изменение
/v1/actions/candidates
/v1/actions/products	Добавили параметры result.products.alert_max_action_price_failed и result.products.alert_max_action_price в ответ методов.
13 мая 2025
Метод	Изменение
...
/v2/returns/rfbs/verify
/v2/returns/rfbs/receive-return
/v2/returns/rfbs/return-money	Методы будут отключены в будущем. Переключитесь на метод /v1/returns/rfbs/action/set.
6 мая 2025
Метод	Изменение
...
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Удалили параметры result.postings.financial_data.products.client_price, result.postings.financial_data.products.picking и result.postings.products.mandatory_mark из ответа методов.
/v3/posting/fbs/get
/v2/posting/fbs/get-by-barcode	Удалили параметры result.financial_data.products.client_price, result.financial_data.products.picking и result.products.mandatory_mark из ответа методов.
/v2/posting/fbo/get
/v2/posting/fbo/list	Удалили параметры result.analytics_data.region, result.financial_data.products.client_price и result.financial_data.products.picking из ответа методов.
...
/v2/posting/fbo/list
/v3/posting/fbs/get
/v2/posting/fbs/get-by-barcode	Удалили устаревшие параметры result.financial_data.posting_services и result.financial_data.products.item_services из ответа методов.
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Удалили устаревшие параметры result.postings.financial_data.posting_services и result.postings.financial_data.products.item_services из ответа методов.
10 апреля 2025
Метод	Изменение
...
/v1/carriage/create
/v1/carriage/approve
/v1/carriage/delivery/list	Перенесли метод из бета-раздела в основной.
27 марта 2025
Метод	Изменение
/v3/posting/fbs/unfulfilled/list
/v3/posting/fbs/list
/v3/posting/fbs/get	Добавили параметр is_blr_traceable в ответы методов.
...
/v5/fbs/posting/product/exemplar/status
/v5/fbs/posting/product/exemplar/validate
/v1/fbs/posting/product/exemplar/update	Перенесли методы из бета-раздела в основной.
14 марта 2025
Метод	Изменение
...
Метод	Изменение
/v1/actions/candidates
/v1/actions/products	Пометили параметр offset в запросе методов как устаревший и добавили параметр пагинации last_id.
11 марта 2025
Метод	Изменение
...
/v1/actions/hotsales/products	Методы устарели, удалили их из документации.
10 марта 2025
Метод	Изменение
...
/v3/posting/fbs/get
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Значения кодов маркировки можно получить через метод /v3/posting/fbs/get c with.product_exemplars: true в запросе или метод /v6/fbs/posting/product/exemplar/create-or-get.
28 февраля 2025
Метод	Изменение
...
/v1/warehouse/list
/v1/actions	Обновили описание метода.
...
Метод	Изменение
/v3/posting/fbs/unfulfilled/list
/v3/posting/fbs/list	Обновили описание параметра result.postings.analytics_data.city в ответе методов.
/v3/posting/fbs/get
/v2/posting/fbo/list
/v2/posting/fbo/get	Обновили описание параметра result.analytics_data.city в ответе методов.
24 февраля 2025
Метод	Изменение
...
/v3/returns/company/fbs	Методы устарели, удалили их из документации. Переключитесь на новую версию /v1/returns/list.
...
/v5/fbs/posting/product/exemplar/status
/v5/fbs/posting/product/exemplar/validate
/v1/fbs/posting/product/exemplar/update	Добавили бета-методы для управления кодами маркировки.
14 февраля 2025
Метод	Изменение
...
/v4/product/info/attributes
/v1/finance/document-b2b-sales
/v1/finance/mutual-settlement	Перенесли методы из бета-раздела в основной.
30 января 2025
Метод	Изменение
...
/v3/posting/fbs/list
/v3/posting/fbs/unfulfilled/list	Добавили параметр result.postings.pickup_code_verified_at в ответы методов.
...
/v1/question/info
/v1/question/list
/v1/question/top-sku	Добавили бета-методы для работы с вопросами и ответами.
27 декабря 2024
Метод	Изменение
/v1/review/comment/create
/v1/review/comment/delete
...
/v1/review/count
/v1/review/info
/v1/review/list	Добавили бета-методы для работы с отзывами.
...
/v1/supply-order/get	Метод устарел, удалили его из документации. Используйте /v3/supply-order/get.
/v1/supply-order/list	Метод устарел, удалили его из документации. Используйте /v3/supply-order/list.
